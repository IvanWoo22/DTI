        ...
        */
        ...
        if (seriesTypes.xrange) {
            ...
            const xrangeHandlePositioner = function (point, xProp) {
                const series = point.series, xAxis = series.xAxis, yAxis = series.yAxis,
                    inverted = series.chart.inverted, offsetY = series.columnMetrics ? series.columnMetrics.offset :
        ...
        function hasDraggedPastSensitivity(e, chart, sensitivity) {
            const orig = chart.dragDropData.origin, oldX = orig.chartX, oldY = orig.chartY, newX = e.chartX,
        ...
        Point.prototype.showDragHandles = function () {
            ...
            objectEach(series.dragDropProps, function (val, key) {
                const handleOptions = merge(defaultDragHandleOptions, val.handleOptions, options.dragHandle),
                    handleAttrs = {
        ...
        function mouseUp(e, chart) {
            ...
            if (dragDropData &&
                ...
                const point = dragDropData.point, newPoints = dragDropData.newPoints,
