...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Funnel/FunnelSeries.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Extensions/BorderRadius.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (Chart, H, BorderRadius, SeriesRegistry, U) {
        ...
        class FunnelSeries extends PieSeries {
             ...
             */
            drawDataLabels() {
                let series = this, data = series.data, labelDistance = series.options.dataLabels.distance, leftSide,
            ...
            translate() {
                let sum = 0, series = this, chart = series.chart, options = series.options, reversed = options.reversed,
                    ...
                    borderRadiusObject = BorderRadius.optionsToObject(options.borderRadius),
                    ...
                    borderRadius = relativeLength(borderRadiusObject.radius, width),
                    radiusScope = borderRadiusObject.scope, alpha, // the angle between top and left point's edges
                ...
                */
                ...
                data.forEach(function (point) {
                    ...
                    if (borderRadius && (radiusScope === 'point' ||
                        ...
                        // (#18839)
                        const h = Math.abs(y3 - y1), xSide = x2 - x4, lBase = x4 - x3,
