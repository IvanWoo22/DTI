...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Item/ItemSeries.js', [_modules['Core/Globals.js'], _modules['Series/Item/ItemPoint.js'], _modules['Core/Defaults.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (H, ItemPoint, D, SeriesRegistry, U) {
        ...
        class ItemSeries extends PieSeries {
             ...
             */
            getSlots() {
                let center = this.center, diameter = center[2], innerSize = center[3], row, slots = this.slots, x, y,
                    rowRadius, rowLength, colCount, increment, angle, col, itemSize = 0, rowCount,
                    fullAngle = (this.endAngleRad - this.startAngleRad), itemCount = Number.MAX_VALUE, finalItemCount,
                    rows, testRows, rowsOption = this.options.rows,
