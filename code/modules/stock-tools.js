...
(function (b) {
    ...
    r(b, "Extensions/Annotations/NavigationBindingsDefaults.js", [b["Extensions/Annotations/NavigationBindingsUtilities.js"], b["Core/Utilities.js"]], function (b, n) {
        const {getAssignedAxis: m} = b, {isNumber: t, merge: e} = n;
        return {
            lang: {
                navigation: {
                    popup: {
                    ...
                    circleAnnotation: {
                        className: "highcharts-circle-annotation", start: function (b) {
                            ...
                            if (b && d) return this.chart.addAnnotation(e({
                                ...
                                shapes: [{
                                    type: "circle",
                                    point: {x: b.value, y: d.value, xAxis: b.axis.index, yAxis: d.axis.index},
                                    r: 5
                                }]
                    ...
                    rectangleAnnotation: {
                        className: "highcharts-rectangle-annotation", start: function (b) {
                            ...
                            if (d && l) {
                                ...
                                return this.chart.addAnnotation(e({
                                        ...
                                        shapes: [{
                                            type: "path",
                                            points: [{xAxis: d, yAxis: l, x: b, y: n}, {
                                                xAxis: d,
                                                yAxis: l,
                                                x: b,
                                                y: n
                                            }, {xAxis: d, yAxis: l, x: b, y: n}, {
                                                xAxis: d,
                                                yAxis: l,
                                                x: b,
                                                y: n
                            ...
                            b = m(l.xAxis);
                            l = m(l.yAxis);
                            b && l && (b = b.value, l = l.value, d[1].x = b, d[2].x = b, d[2].y = l, d[3].y = l, e.update({shapes: [{points: d}]}))
                        }]
                    }, labelAnnotation: {
                        className: "highcharts-label-annotation", start: function (b) {
                            ...
                            if (b && d) return this.chart.addAnnotation(e({
                                ...
                                labels: [{
                                    point: {xAxis: b.axis.index, yAxis: d.axis.index, x: b.value, y: d.value},
                                    overflow: "none",
                                    crop: !0
                                }]
    ...
    r(b, "Extensions/Annotations/NavigationBindings.js", [b["Core/Chart/ChartNavigationComposition.js"], b["Core/Defaults.js"], b["Core/Templating.js"], b["Core/Globals.js"], b["Extensions/Annotations/NavigationBindingsDefaults.js"],
        ...
        function r(a, c) {
            const b = y.Element.prototype, g = b.matches || b.msMatchesSelector || b.webkitMatchesSelector;
            let h = null;
            if (b.closest) h = b.closest.call(a, c); else {
                do {
            ...
            if (this && a) {
                ...
                if (this.navigationBindings && this.navigationBindings.container && this.navigationBindings.container[0]) {
                    ...
                    A(a.boundClassNames, (a,
                                          g) => {
                        if (g = b.querySelectorAll("." + g)) for (let b = 0; b < g.length; b++) {
                            const h = g[b], f = h.className;
        ...
        function f(a) {
            function c(a) {
                const c =
                    this, g = c.chart.navigationBindings, h = g.activeAnnotation;
                b && b.call(c, a);
        ...
        const {setOptions: a} = n, {format: c} = m, {
            doc: h,
            win: y
        } = t, {getFieldType: g} = l, {
            addEvent: x,
        ...
        class z {
            ...
            initEvents() {
                const a = this, c = a.chart, b = a.container, g = a.options;
                a.boundClassNames = {};
                A(g.bindings || {}, c => {
                ...
                A(g.events || {}, (c, b) => {
                    J(c) && a.eventsToUnbind.push(x(a, b, c, {passive: !1}))
                });
                ...
                }, t.isTouchDevice ? {passive: !1} : void 0))
            }
            ...
            bindingsButtonClick(a, c, b) {
                const g = this.chart, h = g.renderer.boxWrapper;
                let f = !0;
                this.selectedButtonElement && (this.selectedButtonElement.classList === a.classList && (f = !1), B(this, "deselectButton", {button: this.selectedButtonElement}), this.nextEvent && (this.currentUserDetails && "annotations" === this.currentUserDetails.coll && g.removeAnnotation(this.currentUserDetails), this.mouseMoveEvent = this.nextEvent = !1));
                f ? (this.selectedButton = c, this.selectedButtonElement = a, B(this, "selectButton", {button: a}),
            ...
            bindingsChartClick(a, c) {
                a = this.chart;
                const b = this.activeAnnotation, g = this.selectedButton;
            ...
            fieldsToOptions(a, c) {
                A(a, (a, b) => {
                    const g = parseFloat(a), h = b.split("."), f = h.length - 1;
                    !H(g) || a.match(/px|em/g) || b.match(/format/g) || (a = g);
                    if ("undefined" !== a) {
                        let b = c;
                        h.forEach((c, g) => {
                            const d = G(h[g + 1], "");
            ...
            getButtonEvents(a, c) {
                ...
                this.getClickedClassNames(a, c).forEach(a => {
                    b.boundClassNames[a[0]] && !g && (g = {events: b.boundClassNames[a[0]], button: a[1]})
                });
                return g
            }
    ...
    r(b, "Stock/StockTools/StockToolsUtilities.js",
        [b["Core/Defaults.js"], b["Extensions/Annotations/NavigationBindingsUtilities.js"], b["Core/Series/Series.js"], b["Core/Utilities.js"]], function (b, n, m, t) {
            ...
            const {getOptions: l} = b, {getAssignedAxis: d, getFieldType: r} = n, {
                    defined: w,
                    fireEvent: v,
                    isNumber: q,
                    uniqueKey: k
                } = t,
                u = "apo ad aroon aroonoscillator atr ao cci chaikin cmf cmo disparityindex dmi dpo linearRegressionAngle linearRegressionIntercept linearRegressionSlope klinger macd mfi momentum natr obv ppo roc rsi slowstochastic stochastic trix williamsr".split(" "),
                p = "ad cmf klinger mfi obv vbp vwap".split(" ");
            return {
                indicatorsWithAxes: u, indicatorsWithVolume: p, addFlagFromForm: function (b) {
                    return function (a) {
                        const c =
                            this, h = c.chart, f = h.stockTools;
                        if (a = e(a, h)) {
                            var g = {
                                type: "flags",
                ...
                }, attractToPoint: e, getAssignedAxis: d, isNotNavigatorYAxis: function (b) {
                    ...
                    const a = this.chart;
                    var c = {linkedTo: b.linkedTo, type: b.type};
                    let h;
                    if ("edit" === b.actionType) this.fieldsToOptions(b.fields, c), (b = a.get(b.seriesId)) && b.update(c, !1); else if ("remove" === b.actionType) {
                    ...
                    } else c.id = k(), this.fieldsToOptions(b.fields, c), f = a.get(c.linkedTo), h = l().plotOptions, "undefined" !== typeof f && f instanceof m && "sum" === f.getDGApproximation() &&
                    !w(h && h[c.type] && h.dataGrouping && h.dataGrouping.approximation) && (c.dataGrouping = {approximation: "sum"}), 0 <= u.indexOf(b.type) ? (f = a.addAxis({
                        id: k(),
                        offset: 0,
                        opposite: !0,
                        title: {text: ""},
                    ...
                    a.redraw()
                }, updateHeight: function (b, a) {
                    const c = a.options.typeOptions, h = q(c.yAxis) && this.chart.yAxis[c.yAxis];
                    h && c.points && a.update({typeOptions: {height: h.toValue(b[h.horiz ? "chartX" : "chartY"]) - (c.points[1].y || 0)}})
                }, updateNthPoint: function (b) {
                    return function (a, c) {
                        const h = c.options.typeOptions, f = q(h.xAxis) && this.chart.xAxis[h.xAxis],
                    ...
                    const c = a.chart;
                    var h = a.options.typeOptions, f = q(h.xAxis) && c.xAxis[h.xAxis],
        ...
        return {
                    ...
                    if (a && c) {
                        ...
                        a = f({
                            ...
                            typeOptions: {
                                xAxis: a.axis.index,
                                yAxis: c.axis.index,
                                points: [{x: b, y: d}, {x: b, y: d}, {x: b, y: d}, {x: b, y: d}]
            ...
            fibonacci: {
                className: "highcharts-fibonacci", start: function (a) {
                    ...
                    b = e(b.yAxis);
                    if (a && b) {
                        var d = a.value, k = b.value, g = this.chart.options.navigation;
                        a = f({
                            langKey: "fibonacci",
                            type: "fibonacci",
                            typeOptions: {
                    ...
                    if (a && b) {
                        ...
                        a = f({
                            ...
                            typeOptions: {
                                xAxis: a.axis.index,
                                yAxis: b.axis.index,
                                points: [{x: a.value, y: b.value, controlPoint: {style: {fill: "#f21313"}}}, {
                                    x: d,
                                    y: k
                                }, {x: d, y: k}],
            ...
            fibonacciTimeZones: {
                className: "highcharts-fibonacci-time-zones", start: function (a) {
                    ...
                    if (a && b) {
                        ...
                        a = f({
                            ...
                            typeOptions: {xAxis: a.axis.index, yAxis: b.axis.index, points: [{x: a.value}]}
                ...
                steps: [function (a, b) {
                    ...
                    a = e(d.xAxis);
                    d = e(d.yAxis);
                    b.update({typeOptions: {xAxis: a.axis.index, yAxis: d.axis.index, points: [{x: c}, {x: a.value}]}})
                }]
            },
            flagCirclepin: {className: "highcharts-flag-circlepin", start: l("circlepin")},
            flagDiamondpin: {className: "highcharts-flag-diamondpin", start: l("flag")},
            flagSquarepin: {className: "highcharts-flag-squarepin", start: l("squarepin")},
            flagSimplepin: {
            ...
            seriesTypeHollowCandlestick: {
                className: "highcharts-series-type-hollowcandlestick", init: function (a) {
            ...
            currentPriceIndicator: {
                className: "highcharts-current-price-indicator", init: function (a) {
                    const b = this.chart, d = b.series, f = b.stockTools, g = w(b.series);
                    f && f.guiEnabled && (d.forEach(function (a) {
                        a.update({lastPrice: {enabled: !g}, lastVisiblePrice: {enabled: !g, label: {enabled: !0}}}, !1)
                    }), b.redraw());
                    p(this, "deselectButton", {button: a})
                }
            },
            ...
            toggleAnnotations: {
                className: "highcharts-toggle-annotations", init: function (a) {
                    const b = this.chart, d = b.stockTools, f = d.getIconsURL();
    ...
    r(b, "Stock/StockTools/StockTools.js", [b["Core/Defaults.js"], b["Extensions/Annotations/NavigationBindingsUtilities.js"], b["Stock/StockTools/StockToolsBindings.js"],
        ...
        function d(b, d, e, k) {
            ...
            return {
                positions: b.map((a, k) => {
                    ...
                    p ? (a > u && (a -= p), h = Math.max(h, (a || 0) + (l || 0))) :
                        (c(l) || (l = b[k - 1].series.every(a => a.is("sma")) ? q : e / 100), c(a) || (a = h), q = l, h = f(Math.max(h, (a || 0) + (l || 0))));
                    return {height: 100 * l, top: 100 * a}
                }), allAxesHeight: h
            }
        }
        ...
        function r(a) {
            ...
            a.forEach(function (c, g) {
                c = a[g + 1];
                b[g] = c ? {enabled: !0, controlledAxis: {next: [h(c.options.id, c.index)]}} : {enabled: !1}
            });
            return b
        }
        ...
        function v(a) {
            const b = this.chart, c = b.yAxis.filter(u), {positions: g, allAxesHeight: d} =
                this.getYAxisPositions(c, b.plotHeight, 20, a), e = this.getYAxisResizers(c);
            !a && d <= f(1) ? g[g.length - 1] = {height: 20, top: f(100 * d - 20)} : g.forEach(function (a) {
                a.height = a.height / (100 * d) * 100;
                a.top = a.top / (100 * d) * 100
            });
            g.forEach(function (a, b) {
                c[b].update({height: a.height + "%", top: a.top + "%", resize: e[b], offset: 0}, !1)
            })
        }

        const {setOptions: q} = b, {getAssignedAxis: k} = n, {
            isNotNavigatorYAxis: u,
            isPriceIndicatorEnabled: p
        } = e, {correctFloat: f, defined: a, isNumber: c, pick: h} = l, y = [];
        return {
            compose: function (a) {
                l.pushUnique(y, a) && (a = a.prototype,
                    a.getYAxisPositions = d, a.getYAxisResizers = r, a.recalculateYAxisPositions = w, a.resizeYAxes = v, a.utils = {
                ...
                l.pushUnique(y, q) && (q(t), q({navigation: {bindings: m}}))
            }
        }
    });
    r(b, "Stock/StockTools/StockToolbar.js", [b["Core/Utilities.js"]], function (b) {
        const {addEvent: n, createElement: m, css: t, fireEvent: e, getStyle: l, isArray: d, merge: r, pick: w} = b;
        ...
        class v {
            ...
            init() {
                const b = this.lang, e = this.options, l = this.toolbar, p = e.definitions, f = l.childNodes;
                e.buttons.forEach(a => {
                    const c = this.addButton(l, p, a, b);
                    this.eventsToUnbind.push(n(c.buttonWrapper, "click", () => this.eraseActiveButtons(f, c.buttonWrapper)));
                    d(p[a].items) && this.addSubmenu(c, p[a])
                })
            }

            addSubmenu(b, d) {
                const e = b.submenuArrow, k = b.buttonWrapper, f = l(k, "width"), a = this.wrapper,
                    c = this.listWrapper, h = this.toolbar.childNodes,
                    q = this.submenu = m("ul", {className: "highcharts-submenu-wrapper"}, void 0, k);
                this.addSubmenuItems(k, d);
                this.eventsToUnbind.push(n(e, "click", b => {
                    b.stopPropagation();
                    this.eraseActiveButtons(h, k);
                    0 <= k.className.indexOf("highcharts-current") ?
                        (c.style.width = c.startWidth + "px", k.classList.remove("highcharts-current"), q.style.display = "none") : (q.style.display = "block", b = q.offsetHeight - k.offsetHeight - 3, q.offsetHeight + k.offsetTop > a.offsetHeight && k.offsetTop > b || (b = 0), t(q, {
                            top: -b + "px",
                            left: f + 3 + "px"
            ...
            addSubmenuItems(b, d) {
                const e = this, k = this.submenu, f = this.lang, a = this.listWrapper;
                let c;
                d.items.forEach(h => {
                    c = this.addButton(k,
                        d, h, f);
                    this.eventsToUnbind.push(n(c.mainButton, "click", function () {
                        e.switchSymbol(this, b, !0);
            ...
            addButton(b, d, e, l = {}) {
                d = d[e];
                const f = d.items, a = d.className || "";
                b = m("li", {className: w(v.prototype.classMapping[e], "") + " " + a, title: l[e] || e}, void 0, b);
                e = m("span", {className: "highcharts-menu-item-btn"}, void 0, b);
                if (f && f.length) return d = m("span", {className: "highcharts-submenu-item-arrow highcharts-arrow-right"}, void 0, b), d.style.backgroundImage = "url(" + this.iconsURL + "arrow-bottom.svg)", {
                    buttonWrapper: b,
                    mainButton: e,
                    submenuArrow: d
                };
                e.style.backgroundImage = "url(" + this.iconsURL + d.symbol + ")";
                return {buttonWrapper: b, mainButton: e}
            }
            ...
            addNavigation() {
                ...
                this.arrowUp = m("div", {className: "highcharts-arrow-up"}, void 0, this.arrowWrapper);
                this.arrowUp.style.backgroundImage = "url(" + this.iconsURL + "arrow-right.svg)";
                this.arrowDown = m("div", {className: "highcharts-arrow-down"}, void 0, this.arrowWrapper);
            ...
            scrollButtons() {
                const b = this.wrapper,
                    d = this.toolbar, e = .1 * b.offsetHeight;
                let l = 0;
                this.eventsToUnbind.push(n(this.arrowUp, "click", () => {
            ...
            createHTML() {
                const b = this.chart;
                var d = this.options, e = b.container;
                const l = b.options.navigation,
                    f = this.wrapper = m("div", {className: "highcharts-stocktools-wrapper " + d.className + " " + (l && l.bindingsClassName)});
                e.appendChild(f);
                ["mousedown", "mousemove",
                    "click", "touchstart"].forEach(a => {
                    n(f, a, a => a.stopPropagation())
                });
                n(f, "mouseover", a => b.pointer.onContainerMouseLeave(a));
                this.toolbar = e = m("ul", {className: "highcharts-stocktools-toolbar " + d.toolbarClassName});
                this.listWrapper = d = m("div", {className: "highcharts-menu-wrapper"});
            ...
            showHideToolbar() {
                const b = this.chart, d = this.wrapper, e = this.listWrapper, p = this.submenu,
                    f = this.showhideBtn = m("div", {className: "highcharts-toggle-toolbar highcharts-arrow-left"}, void 0, d);
                let a = this.visible;
                f.style.backgroundImage = "url(" + this.iconsURL + "arrow-right.svg)";
                a ? (d.style.height = "100%", f.style.top = l(e, "padding-top") + "px", f.style.left = d.offsetWidth + l(e, "padding-left") + "px") : (p && (p.style.display = "none"), f.style.left =
                    "0px", a = this.visible = !1, e.classList.add("highcharts-hide"), f.classList.toggle("highcharts-arrow-right"), d.style.height = f.offsetHeight + "px");
                this.eventsToUnbind.push(n(f, "click", () => {
                    b.update({stockTools: {gui: {visible: !a, placed: !0}}})
                }))
            }
            ...
            switchSymbol(b, d) {
                ...
                -1 < k.indexOf("highcharts-disabled-btn") || (e.className = "", k && e.classList.add(k.trim()), e.querySelectorAll(".highcharts-menu-item-btn")[0].style.backgroundImage = b.style.backgroundImage,
            ...
            update(b, d) {
                ...
                this.chart.isDirtyBox =
                    !0;
                w(d, !0) && this.chart.redraw()
            }

            destroy() {
                const b = this.wrapper, d = b && b.parentNode;
                this.eventsToUnbind.forEach(b => b());
                d && d.removeChild(b)
            }
    ...
    r(b, "Stock/StockTools/StockToolsGui.js", [b["Core/Defaults.js"], b["Stock/StockTools/StockToolsDefaults.js"], b["Stock/StockTools/StockToolbar.js"], b["Core/Utilities.js"]], function (b, n, m, t) {
        ...
        function d() {
            if (this.stockTools) {
                var b =
                    this.options.chart, c = this.stockTools.listWrapper;
                c = c && (c.startWidth + a(c, "padding-left") + a(c, "padding-right") || c.offsetWidth);
                var d = !1;
        ...
        const {setOptions: p} = b, {addEvent: f, getStyle: a, merge: c, pick: h} = t, y = [];
        return {
            compose: function (a, b) {
                t.pushUnique(y, a) && (f(a, "afterGetContainer", l), f(a, "beforeRedraw", d), f(a, "beforeRender", d), f(a, "destroy", r), f(a, "getMargins", w, {order: 0}), f(a, "redraw", v), f(a, "render", q), a.prototype.setStockTools = e);
    ...
    r(b, "masters/modules/stock-tools.src.js", [b["Core/Globals.js"],
        b["Extensions/Annotations/NavigationBindings.js"], b["Stock/StockTools/StockTools.js"], b["Stock/StockTools/StockToolsGui.js"], b["Stock/StockTools/StockToolbar.js"]], function (b, n, m, r, e) {
        b.Toolbar = e;
        m.compose(n);
        r.compose(b.Chart, n)
    })
