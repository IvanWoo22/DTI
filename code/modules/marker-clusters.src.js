...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/MarkerClusters.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Defaults.js'], _modules['Core/Series/Point.js'], _modules['Core/Series/Series.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js'], _modules['Core/Axis/Axis.js']], function (A, Chart, D, Point, Series, SeriesRegistry, SVGRenderer, U, Axis) {
        ...
        Scatter.prototype.animateClusterPoint = function (clusterObj) {
            ...
            let parentId, oldPointObj, newPointObj, newPointBBox, offset = 0, newX = 0, newY = 0,
                isOldPointGrahic = false, isCbHandled = false;
        ...
        Scatter.prototype.getGridOffset = function () {
            let series = this, chart = series.chart, xAxis = series.xAxis, yAxis = series.yAxis, plotLeft = 0,
                plotTop = 0;
        ...
        Scatter.prototype.markerClusterAlgorithms = {
            ...
            kmeans: function (dataX, dataY, dataIndexes, options) {
                let series = this, clusters = [], noise = [], group = {},
        ...
        Scatter.prototype.preventClusterCollisions = function (props) {
            let series = this, [gridY, gridX] = props.key.split('-').map(parseFloat), gridSize = props.gridSize,
                groupedData = props.groupedData, defaultRadius = props.defaultRadius,
                clusterRadius = props.clusterRadius, gridXPx = gridX * gridSize, gridYPx = gridY * gridSize,
                propsPx = valuesToPixels(series, props), xPixel = propsPx.x, yPixel = propsPx.y,
        ...
        Scatter.prototype.generatePoints = function () {
            const series = this, chart = series.chart, mapView = chart.mapView, xData = series.xData,
                yData = series.yData, clusterOptions = series.options.cluster, realExtremes = series.getRealExtremes(),
                visibleXData = [], visibleYData = [], visibleDataIndexes = [];
            let oldPointsState, oldDataLen, oldMarkerClusterInfo, kmeansThreshold, cropDataOffsetX, cropDataOffsetY,
                seriesMinX, seriesMaxX, seriesMinY, seriesMaxY, type, algorithm, clusteredData, groupedData,
                layoutAlgOptions, point, i;
