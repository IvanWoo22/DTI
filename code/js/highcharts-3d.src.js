...
(function (factory) {
        ...
        class SVGRenderer3D extends SVGRenderer {
            ...
            cuboidPath(shapeArgs) {
                let x = shapeArgs.x || 0, y = shapeArgs.y || 0, z = shapeArgs.z || 0,
                    ...
                    chart = charts[this.chartIndex], front, back, top, bottom, left, right, shape, path1, path2, path3,
                    isFront, isTop, isRight, options3d = chart.options.chart.options3d, alpha = options3d.alpha,
        ...
        (function (Chart3D) {
            ...
            class Composition {
                ...
                get3dFrame() {
                    ...
                    let defaultShowBottom = false, defaultShowTop = false, defaultShowLeft = false,
            ...
            function onAfterSetChartSize() {
                ...
                if (chart.chart3d &&
                    ...
                    const inverted = chart.inverted, clipBox = chart.clipBox, margin = chart.margin,
    ...
    _registerModule(_modules, 'Core/Axis/Axis3DComposition.js', [_modules['Core/Axis/Axis3DDefaults.js'], _modules['Core/Globals.js'], _modules['Core/Math3D.js'], _modules['Core/Axis/Tick3DComposition.js'], _modules['Core/Utilities.js']], function (Axis3DDefaults, H, Math3D, Tick3D, U) {
        ...
        function wrapAxisGetPlotBandPath(proceed) {
            ...
            const args = arguments, from = args[1], to = args[2], path = [],
        ...
        function wrapAxisGetSlotWidth(proceed, tick) {
            ...
            if (axis.categories &&
                ...
                const firstGridLine = (gridGroup.element.childNodes[0].getBBox()),
                    frame3DLeft = chart.frameShapes.left.getBBox(), options3d = chart.options.chart.options3d,
                    origin = {
                        x: chart.plotWidth / 2,
                        y: chart.plotHeight / 2,
                        z: options3d.depth / 2,
    ...
    _registerModule(_modules, 'Series/Column3D/Column3DComposition.js', [_modules['Series/Column/ColumnSeries.js'], _modules['Core/Series/Series.js'], _modules['Core/Math3D.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Axis/Stacking/StackItem.js'], _modules['Core/Utilities.js']], function (ColumnSeries, Series, Math3D, SeriesRegistry, StackItem, U) {
        ...
        wrap(columnProto, 'animate', function (proceed) {
            if (!this.chart.is3d()) {
                ...
                const args = arguments, init = args[1], yAxis = this.yAxis, series = this,
        ...
        wrap(Series.prototype, 'alignDataLabel', function (proceed, point, dataLabel, options, alignTo) {
            ...
            if (chart.is3d() &&
                this.is('column')) {
                const series = this, seriesOptions = series.options,
