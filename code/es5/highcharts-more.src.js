...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/AreaRange/AreaRangePoint.js', [_modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (SeriesRegistry, U) {
        ...
        var _a = SeriesRegistry.seriesTypes.area.prototype, AreaPoint = _a.pointClass,
    ...
    _registerModule(_modules, 'Series/AreaRange/AreaRangeSeries.js', [_modules['Series/AreaRange/AreaRangePoint.js'], _modules['Core/Globals.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (AreaRangePoint, H, SeriesRegistry, U) {
        ...
        var addEvent = U.addEvent, defined = U.defined, extend = U.extend, isArray = U.isArray, isNumber = U.isNumber,
            pick = U.pick, merge = U.merge;
        /* *
         *
         *  Constants
         *
        ...
        var AreaRangeSeries = /** @class */ (function (_super) {
            ...
            AreaRangeSeries.prototype.getGraphPath = function (points) {
                var highPoints = [], highAreaPoints = [], getGraphPath = areaProto.getGraphPath, options = this.options,
            ...
            AreaRangeSeries.prototype.drawDataLabels = function () {
                var data = this.points, length = data.length, originalDataLabels = [],
                ...
                if (dataLabelOptions) {
                    ...
                    if (upperDataLabelOptions.enabled || this._hasPointLabels) {
                        ...
                        while (i--) {
                            point = data[i];
                            if (point) {
                                var _a = point.plotHigh, plotHigh = _a === void 0 ? 0 : _a, _b = point.plotLow,
                    ...
                    if (lowerDataLabelOptions.enabled || this._hasPointLabels) {
                        ...
                        while (i--) {
                            point = data[i];
                            if (point) {
                                var _c = point.plotHigh, plotHigh = _c === void 0 ? 0 : _c, _d = point.plotLow,
    ...
    _registerModule(_modules, 'Series/ColumnRange/ColumnRangePoint.js', [_modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (SeriesRegistry, U) {
        ...
        var _a = SeriesRegistry.seriesTypes, columnProto = _a.column.prototype.pointClass.prototype,
    ...
    _registerModule(_modules, 'Series/ColumnRange/ColumnRangeSeries.js', [_modules['Series/ColumnRange/ColumnRangePoint.js'], _modules['Core/Globals.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (ColumnRangePoint, H, SeriesRegistry, U) {
        ...
        var _a = SeriesRegistry.seriesTypes, AreaRangeSeries = _a.arearange, ColumnSeries = _a.column,
            columnProto = _a.column.prototype;
        var addEvent = U.addEvent, clamp = U.clamp, extend = U.extend, isNumber = U.isNumber, merge = U.merge,
            pick = U.pick;
        /* *
         *
         *  Constants
        ...
        var ColumnRangeSeries = /** @class */ (function (_super) {
            ...
            ColumnRangeSeries.prototype.afterColumnTranslate = function () {
                 ...
                 * @private
                 */
                var yAxis = this.yAxis, xAxis = this.xAxis, startAngleRad = xAxis.startAngleRad, chart = this.chart,
                ...
                this.points.forEach(function (point) {
                    var shapeArgs = point.shapeArgs || {}, minPointLength = _this.options.minPointLength,
                        plotY = point.plotY, plotHigh = yAxis.translate(point.high, 0, 1, 0, 1);
                    if (isNumber(plotHigh) && isNumber(plotY)) {
                        ...
                        if (isRadial && _this.polar) {
                            ...
                            shapeArgs.y = y;
                            var _a = shapeArgs.x, x = _a === void 0 ? 0 : _a, _b = shapeArgs.width,
    ...
    _registerModule(_modules, 'Series/PackedBubble/PackedBubbleSeries.js', [_modules['Core/Color/Color.js'], _modules['Series/DragNodesComposition.js'], _modules['Series/GraphLayoutComposition.js'], _modules['Core/Globals.js'], _modules['Series/PackedBubble/PackedBubblePoint.js'], _modules['Series/PackedBubble/PackedBubbleSeriesDefaults.js'], _modules['Series/PackedBubble/PackedBubbleLayout.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Series/SimulationSeriesUtilities.js'], _modules['Core/Utilities.js'], _modules['Core/Animation/AnimationUtilities.js']], function (Color, DragNodesComposition, GraphLayout, H, PackedBubblePoint, PackedBubbleSeriesDefaults, PackedBubbleLayout, SeriesRegistry, D, U, A) {
        ...
        var addEvent = U.addEvent, clamp = U.clamp, defined = U.defined, extend = U.extend, fireEvent = U.fireEvent,
            isArray = U.isArray, isNumber = U.isNumber, merge = U.merge, pick = U.pick, syncTimeout = U.syncTimeout;
        var animObject = A.animObject;
        /* *
         *
         *  Class
        ...
        var PackedBubbleSeries = /** @class */ (function (_super) {
            ...
            PackedBubbleSeries.prototype.addLayout = function () {
                ...
                var graphLayoutsStorage = this.chart.graphLayoutsStorage,
                    graphLayoutsLookup = this.chart.graphLayoutsLookup, layout;
            ...
            PackedBubbleSeries.prototype.createParentNodes = function () {
                var _this = this;
                var PackedBubblePoint = this.pointClass, chart = this.chart, parentNodeLayout = this.parentNodeLayout,
            ...
            PackedBubbleSeries.prototype.getPointRadius = function () {
                var _this = this;
                var chart = this.chart, plotWidth = chart.plotWidth, plotHeight = chart.plotHeight,
            ...
            PackedBubbleSeries.prototype.translate = function () {
                var chart = this.chart, data = this.data, index = this.index,
    ...
    _registerModule(_modules, 'Series/Waterfall/WaterfallSeries.js', [_modules['Core/Axis/Axis.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js'], _modules['Core/Axis/WaterfallAxis.js'], _modules['Series/Waterfall/WaterfallPoint.js']], function (Axis, Chart, SeriesRegistry, U, WaterfallAxis, WaterfallPoint) {
        ...
        var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, correctFloat = U.correctFloat,
            extend = U.extend, isNumber = U.isNumber, merge = U.merge, objectEach = U.objectEach, pick = U.pick;
        ...
        var WaterfallSeries = /** @class */ (function (_super) {
            ...
            WaterfallSeries.prototype.getCrispPath = function () {
                var data = this.data.filter(function (d) {
                        ...
                        return isNumber(d.y);
                    }), yAxis = this.yAxis, length = data.length,
            ...
            WaterfallSeries.prototype.setStackedPoints = function () {
                var series = this, options = series.options, waterfallStacks = series.yAxis.waterfall.stacks,
                    seriesThreshold = options.threshold || 0, stackThreshold = seriesThreshold,
                    interSum = stackThreshold, stackKey = series.stackKey, xData = series.xData, xLength = xData.length,
                    actualStackX, totalYVal, actualSum, prevSum, statesLen, posTotal, negTotal, xPoint, yVal, x,
        ...
        addEvent(WaterfallSeries, 'afterColumnTranslate', function () {
            var series = this, options = series.options, points = series.points, yAxis = series.yAxis,
                minPointLength = pick(options.minPointLength, 5), halfMinPointLength = minPointLength / 2,
                threshold = options.threshold || 0, stacking = options.stacking,
    ...
    _registerModule(_modules, 'Core/Axis/RadialAxis.js', [_modules['Core/Axis/AxisDefaults.js'], _modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (AxisDefaults, D, H, U) {
        ...
        (function (RadialAxis) {
            ...
            function onAxisAfterInit() {
                var chart = this.chart, options = this.options, isHidden = chart.angular && this.isXAxis,
                    pane = this.pane, paneOptions = pane && pane.options;
    ...
    _registerModule(_modules, 'Series/PolarComposition.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Globals.js'], _modules['Core/Series/Series.js'], _modules['Extensions/Pane.js'], _modules['Core/Axis/RadialAxis.js'], _modules['Core/Utilities.js']], function (A, H, Series, Pane, RadialAxis, U) {
        ...
        var animObject = A.animObject;
        var addEvent = U.addEvent, defined = U.defined, find = U.find, isNumber = U.isNumber, merge = U.merge,
            pick = U.pick, relativeLength = U.relativeLength, splat = U.splat, uniqueKey = U.uniqueKey, wrap = U.wrap;
        /* *
         *
         *  Constants
         *
        ...
        function getConnectors(segment, index, calculateNeighbours, connectEnds) {
            ...
            var prevPointInd = ((i - 1 < 0) ? segment.length - (1 + addedNumber) : i - 1),
                ...
                previousPoint = segment[prevPointInd], nextPoint = segment[nextPointInd],
                previousX = previousPoint.plotX, previousY = previousPoint.plotY, nextX = nextPoint.plotX,
                nextY = nextPoint.plotY, plotX = segment[i].plotX, // actual point
        ...
        function onPointerGetSelectionBox(event) {
            var marker = event.args.marker, xAxis = this.chart.xAxis[0], yAxis = this.chart.yAxis[0],
                inverted = this.chart.inverted, radialAxis = inverted ? yAxis : xAxis,
        ...
        function onPointerGetSelectionMarkerAttrs(event) {
            ...
            if (chart.polar && chart.hoverPane && chart.hoverPane.axis) {
                event.preventDefault();
                var center = chart.hoverPane.center, mouseDownX = (this.mouseDownX || 0),
                    mouseDownY = (this.mouseDownY || 0), chartY = event.args.chartY, chartX = event.args.chartX,
                    fullCircle = Math.PI * 2, startAngleRad = chart.hoverPane.axis.startAngleRad,
                ...
                if (this.zoomHor) {
                    ...
                    var startAngle = Math.atan2(mouseDownY - chart.plotTop - center[1], mouseDownX - chart.plotLeft - center[0]) - startAngleRad,
                    ...
                    if (linearAxis.options.gridLineInterpolation === 'polygon') {
                        var radialAxis = chart.hoverPane.axis, tickInterval = radialAxis.tickInterval,
                ...
                if (this.zoomHor &&
                    ...
                    var radialAxis = chart.hoverPane.axis, start = attrs.start || 0, end = attrs.end || 0,
                        min = start - radialAxis.startAngleRad + radialAxis.pos, max = end - start,
                        pathStart = radialAxis.toValue(min), pathEnd = radialAxis.toValue(min + max);
                    // Trim path
                    if (attrs.d instanceof Array) {
                        var innerPath = attrs.d.slice(0, attrs.d.length / 2),
        ...
        function searchPointByAngle(e) {
            var series = this, chart = series.chart, xAxis = series.xAxis, center = xAxis.pane && xAxis.pane.center,
        ...
        function trimPath(path, start, end, radialAxis) {
            ...
            var lastTick = find(ticks, function (tick) {
                return tick >= end;
            }), firstTick = find(__spreadArray([], ticks, true).reverse(), function (tick) {
                return tick <= start;
            });
            if (!defined(lastTick)) {
        ...
        function onAfterColumnTranslate() {
            var series = this, options = series.options, stacking = options.stacking, chart = series.chart,
            ...
            var threshold = options.threshold, thresholdAngleRad = 0, points, point, i, yMin, yMax, start = 0, end = 0,
        ...
        function wrapPointerGetCoordinates(proceed, e) {
            ...
            if (chart.polar) {
                chart.axes.forEach(function (axis) {
                    ...
                    var isXAxis = axis.isXAxis, center = axis.center, x = e.chartX - center[0] - chart.plotLeft,
        ...
        function wrapSeriesAnimate(proceed, init) {
            var series = this, chart = this.chart, group = this.group, markerGroup = this.markerGroup,
        ...
        var PolarAdditions = /** @class */ (function () {
            ...
            PolarAdditions.prototype.arc = function (low, high, start, end) {
                var series = this.series, center = series.xAxis.center, len = series.yAxis.len,
                    paneInnerR = center[3] / 2;
            ...
            PolarAdditions.prototype.toXY = function (point) {
                var series = this.series, chart = series.chart, xAxis = series.xAxis, yAxis = series.yAxis,
