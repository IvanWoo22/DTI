...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/Boost/BoostChart.js', [_modules['Extensions/Boost/BoostableMap.js'], _modules['Core/Utilities.js']], function (BoostableMap, U) {
        ...
        function isChartSeriesBoosting(chart) {
            var allSeries = chart.series, boost = chart.boost = chart.boost || {},
                boostOptions = chart.options.boost || {}, threshold = pick(boostOptions.seriesThreshold, 50);
    ...
    _registerModule(_modules, 'Extensions/Boost/WGLShader.js', [_modules['Core/Utilities.js']], function (U) {
        ...
        var WGLShader = /** @class */ (function () {
            ...
            WGLShader.prototype.createShader = function () {
                var _this = this;
                var v = this.stringToProgram(vertexShader, 'vertex'),
                    f = this.stringToProgram(fragmentShader, 'fragment'), uloc = function (n) {
                        return (_this.gl.getUniformLocation(_this.shaderProgram, n));
                    };
                if (!v || !f) {
    ...
    _registerModule(_modules, 'Extensions/Boost/WGLRenderer.js', [_modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['Extensions/Boost/WGLDrawMode.js'], _modules['Extensions/Boost/WGLShader.js'], _modules['Extensions/Boost/WGLVertexBuffer.js']], function (Color, H, U, WGLDrawMode, WGLShader, WGLVertexBuffer) {
        ...
        var WGLRenderer = /** @class */ (function () {
            ...
            WGLRenderer.prototype.pushSeriesData = function (series, inst) {
                var _this = this;
                var data = this.data, settings = this.settings, vbuffer = this.vbuffer,
                    ...
                    closestLeft = {x: Number.MAX_VALUE, y: 0}, closestRight = {x: -Number.MAX_VALUE, y: 0},
                    cullXThreshold = 1, cullYThreshold = 1, chartDestroyed = typeof chart.index === 'undefined',
                    drawAsBar = asBar[series.type], zoneAxis = options.zoneAxis || 'y', zones = options.zones || false,
                    threshold = options.threshold, pixelRatio = this.getPixelRatio();
                var // plotHeight = series.chart.plotHeight,
                    ...
                    x, y, d, z, i = -1, px = false, nx = false, low, nextInside = false, prevInside = false,
                    pcolor = false, isXInside = false, isYInside = true, firstPoint = true, zoneColors,
                    zoneDefColor = false, gapSize = false, vlen = 0;
                    ...
                    points.forEach(function (point) {
                        ...
                        if (typeof plotY !== 'undefined' &&
                            ...
                            var _a = point.shapeArgs, _b = _a.x, x_1 = _b === void 0 ? 0 : _b, _c = _a.y,
                                y_1 = _c === void 0 ? 0 : _c, _d = _a.width, width = _d === void 0 ? 0 : _d,
            ...
            WGLRenderer.prototype.renderChart = function (chart) {
                ...
                this.series.forEach(function (s, si) {
                    var options = s.series.options, shapeOptions = options.marker,
    ...
    _registerModule(_modules, 'Extensions/Boost/BoostSeries.js', [_modules['Extensions/Boost/BoostableMap.js'], _modules['Extensions/Boost/Boostables.js'], _modules['Extensions/Boost/BoostChart.js'], _modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['Extensions/Boost/WGLRenderer.js']], function (BoostableMap, Boostables, BoostChart, D, H, U, WGLRenderer) {
        ...
        var addEvent = U.addEvent, error = U.error, extend = U.extend, fireEvent = U.fireEvent, isArray = U.isArray,
            isNumber = U.isNumber, pick = U.pick, wrap = U.wrap;
        /* *
         *
         *  Constants
         *
        ...
        function compose(SeriesClass, seriesTypes, wglMode) {
            ...
            if (wglMode) {
                var AreaSeries = seriesTypes.area, AreaSplineSeries = seriesTypes.areaspline,
                    BubbleSeries = seriesTypes.bubble, ColumnSeries = seriesTypes.column,
                    HeatmapSeries = seriesTypes.heatmap, ScatterSeries = seriesTypes.scatter,
        ...
        function enterBoost(series) {
            series.boost = series.boost || {
                ...
                getPoint: (function (bp) {
                    return getPoint(series, bp);
                })
            };
        ...
        function hasExtremes(series, checkX) {
            var options = series.options, data = options.data, xAxis = series.xAxis && series.xAxis.options,
        ...
        function seriesRenderCanvas() {
            var _this = this;
            var options = this.options || {}, chart = this.chart, xAxis = this.xAxis, yAxis = this.yAxis,
                ...
                sampling = !!this.sampling, enableMouseTracking = options.enableMouseTracking,
                threshold = options.threshold, isRange = this.pointArrayMap &&
    ...
    _registerModule(_modules, 'Extensions/BoostCanvas.js', [_modules['Extensions/Boost/BoostChart.js'], _modules['Extensions/Boost/BoostSeries.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Series/Series.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (BoostChart, BoostSeries, Chart, Color, H, Series, SeriesRegistry, U) {
        ...
        var initCanvasBoost = function () {
                        ...
                        this.points.forEach(function (point) {
                            ...
                            if (typeof plotY !== 'undefined' &&
                                ...
                                var _a = point.shapeArgs || {}, _b = _a.x, x = _b === void 0 ? 0 : _b, _c = _a.y,
                                    y = _c === void 0 ? 0 : _c, _d = _a.width, width = _d === void 0 ? 0 : _d,
                                    _e = _a.height, height = _e === void 0 ? 0 : _e;
                                if (!chart.styledMode) {
                                    pointAttr = point.series.pointAttribs(point);
                                } else {
            ...
            extend(Series.prototype, {
                 ...
                 */
                getContext: function () {
                    var chart = this.chart, target = isChartSeriesBoosting(chart) ? chart : this,
                        targetGroup = (target === chart ?
                            chart.seriesGroup :
                            chart.seriesGroup || this.group);
                    var width = chart.chartWidth, height = chart.chartHeight, ctx,
