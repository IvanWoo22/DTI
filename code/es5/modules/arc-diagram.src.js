        ...
        var ArcDiagramSeries = /** @class */ (function (_super) {
            ...
            ArcDiagramSeries.prototype.createNodeColumns = function () {
                ...
                column.sankeyColumn.getTranslationFactor = function (series) {
                    ...
                    var skipPoint, factor = 0, i, radius, maxRadius = 0, scale = 1, additionalSpace = 0,
            ...
            ArcDiagramSeries.prototype.translateLink = function (point) {
                var _a, _b;
                var series = this, fromNode = point.fromNode, toNode = point.toNode, chart = this.chart,
                    translationFactor = series.translationFactor, pointOptions = point.options,
            ...
            ArcDiagramSeries.prototype.translateNode = function (node, column) {
                var series = this, translationFactor = series.translationFactor, chart = series.chart,
                ...
                if (sum) {
                    ...
                    node.nodeY = top;
                    var x = fromNodeLeft, width = node.options.width || options.width || nodeHeight,
