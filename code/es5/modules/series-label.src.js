...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/SeriesLabel/SeriesLabel.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Templating.js'], _modules['Core/Defaults.js'], _modules['Extensions/SeriesLabel/SeriesLabelDefaults.js'], _modules['Extensions/SeriesLabel/SeriesLabelUtilities.js'], _modules['Core/Utilities.js']], function (A, Chart, T, D, SeriesLabelDefaults, SLU, U) {
        ...
        function checkClearPoint(series, x, y, bBox, checkDistance) {
            var chart = series.chart, seriesLabelOptions = series.options.label || {},
            ...
            for (i = 0; i < chart.series.length; i += 1) {
                var serie = chart.series[i],
                    points = serie.interpolatedPoints && __spreadArray([], serie.interpolatedPoints, true);
            ...
            chart.series.forEach(function (s) {
                return (s.points || []).forEach(function (p) {
                    return (p.dataLabels || []).forEach(function (label) {
                        var _a = label.getBBox(), width = _a.width, height = _a.height,
        ...
        function getPointsOnGraph(series) {
            ...
            var distance = 16, points = series.points, interpolated = [], graph = series.graph || series.area,
                node = graph && graph.element, inverted = series.chart.inverted, xAxis = series.xAxis,
                yAxis = series.yAxis, paneLeft = inverted ? yAxis.pos : xAxis.pos,
                paneTop = inverted ? xAxis.pos : yAxis.pos, seriesLabelOptions = series.options.label || {},
                onArea = pick(seriesLabelOptions.onArea, !!series.area),
        ...
        function onChartRedraw(e) {
            if (this.renderer) {
                ...
                chart_1.series.forEach(function (series) {
                    var seriesLabelOptions = series.options.label || {}, label = series.labelBySeries,
