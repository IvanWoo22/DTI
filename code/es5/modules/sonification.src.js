...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/Sonification/SynthPatch.js', [_modules['Core/Utilities.js']], function (U) {
        ...
        function scheduleGainEnvelope(envelope, type, time, gainNode, volumeMultiplier) {
            ...
            envelope.forEach(function (ep, ix) {
                var prev = envelope[ix - 1], delta = prev ? (ep.t - prev.t) / 1000 : 0,
        ...
        var Oscillator = /** @class */ (function () {
            ...
            Oscillator.prototype.setFreqAtTime = function (time, frequency, glideDuration) {
                if (glideDuration === void 0) {
                    glideDuration = 0;
                }
                var opts = this.options, f = clamp(pick(opts.fixedFrequency, frequency) *
                        (opts.freqMultiplier || 1), 0, 21000), oscTarget = this.getOscTarget(),
            ...
            Oscillator.prototype.scheduleVolTrackingChange = function (frequency, time, glideDuration) {
                if (this.volTrackingNode) {
                    var v = getPitchTrackedMultiplierVal(this.options.volumePitchTrackingMultiplier || 1, frequency),
            ...
            Oscillator.prototype.scheduleFilterTrackingChange = function (frequency, time, glideDuration) {
                var opts = this.options, rampTime = glideDuration ? glideDuration / 1000 :
                    ...
                    var multiplier = getPitchTrackedMultiplierVal(filterOptions.frequencyPitchTrackingMultiplier || 1, frequency),
            ...
            Oscillator.prototype.createSoundSource = function () {
                ...
                if (opts.type === 'whitenoise') {
                    var bSize = ctx.sampleRate * 2, buffer = ctx.createBuffer(1, bSize, ctx.sampleRate),
        ...
        var SynthPatch = /** @class */ (function () {
            function SynthPatch(audioContext, options) {
                ...
                this.oscillators = (this.options.oscillators || []).map(function (oscOpts) {
                    return new Oscillator(audioContext, oscOpts, defined(oscOpts.fmOscillator) || defined(oscOpts.vmOscillator) ?
                        void 0 : inputNode);
                });
        ...
        var SonificationInstrument = /** @class */ (function () {
            ...
            SonificationInstrument.prototype.cancel = function () {
                ...
                [
                    ...
                    return (p && p.cancelScheduledValues(0));
                });
            };
            /**
            ...
            SonificationInstrument.noteStringToC0Distance = function (note) {
                ...
                var match = note.match(/^([a-g][#b]?)([0-8])$/i), semitone = match ? match[1] : 'a',
    ...
    _registerModule(_modules, 'Extensions/Sonification/SonificationSpeaker.js', [_modules['Core/Utilities.js']], function (U) {
        ...
        var SonificationSpeaker = /** @class */ (function () {
            ...
            SonificationSpeaker.prototype.setVoice = function () {
                if (this.synthesis) {
                    var name_1 = this.options.name, lang = this.options.language || 'en-US',
    ...
    _registerModule(_modules, 'Extensions/Sonification/MIDI.js', [_modules['Extensions/Sonification/SonificationInstrument.js'], _modules['Core/Utilities.js']], function (SonificationInstrument, U) {
        ...
        var pick = U.pick;
        var freqToNote = function (f) {
                return Math.round(12 * Math.log(f) / Math.LN2 - 48.37632);
            }, b = function (byte, n) {
                return n >>> 8 * byte & 0xFF;
            }, getHeader = function (nTracks) {
                return [
                    0x4D, 0x54, 0x68, 0x64,
                    0, 0, 0, 6,
                    0, nTracks > 1 ? 1 : 0,
            ...
            varLenEnc = function (n) {
                ...
                events.forEach(function (e) {
                    var o = e.instrumentEventOptions || {}, t = e.time, dur = cachedDur = pick(o.noteDuration, cachedDur),
                    ...
                    // CTRL_CHANGE events
                    ctrl.forEach(function (ctrlDef) {
                        return Object.keys(ctrlDef.data)
                ...
                var prevTime = 0;
                var metaEvents = getMetaEvents(midiTrackName, midiInstrument),
                    trackEvents = toMIDIEvents(events).reduce(function (data, e) {
        ...
        function toMIDI(channels) {
            ...
            }), numCh = channelsToAdd.length, multiCh = numCh > 1;
    ...
    _registerModule(_modules, 'Extensions/Sonification/SonificationTimeline.js', [_modules['Extensions/Sonification/TimelineChannel.js'], _modules['Extensions/Sonification/MIDI.js'], _modules['Extensions/DownloadURL.js'], _modules['Core/Utilities.js']], function (TimelineChannel, toMIDI, DU, U) {
        ...
        function filterChannels(filter, channels) {
            ...
            return filtered.map(function (c) {
                return (new TimelineChannel(c.channel.type, c.channel.engine, c.channel.showPlayMarker, c.filteredEvents.map(function (e) {
        ...
        var SonificationTimeline = /** @class */ (function () {
            ...
            SonificationTimeline.prototype.play = function (filter, filterPersists, resetAfter, onEnd) {
                ...
                this.isPaused = false;
                this.isPlaying = true;
                var skipThreshold = this.options.skipThreshold || 2, onPlay = this.options.onPlay,
                    showTooltip = this.options.showTooltip, showCrosshair = this.options.showCrosshair,
                    channels = filter ?
                ...
                channels.forEach(function (channel) {
                    ...
                    var _loop_1 = function (i) {
                        ...
                        var point = e.relatedPoint, chart = point && point.series && point.series.chart,
                            ...
                            _this.scheduledCallbacks.push(setTimeout(function () {
                                ...
                                if (point) {
                                    ...
                                    if (showTooltip && !(
                                        ...
                                        find(chart.hoverPoints, function (p) {
                                            return p === point;
                                        }) &&
            ...
            SonificationTimeline.prototype.playSegment = function (segment, onEnd) {
                ...
                if (eventTimes.first < Infinity) {
                    var segmentSize = (eventTimes.last - eventTimes.first) / numSegments,
                        fromTime_1 = eventTimes.first + segment * segmentSize, toTime_1 = fromTime_1 + segmentSize;
                    ...
                    this.play(function (e) {
                        return e.time >= fromTime_1 && e.time <= toTime_1;
                    }, false, false, onEnd);
                    this.playingChannels = this.playingChannels || this.channels;
                    this.isPaused = true;
                    this.isPlaying = false;
            ...
            SonificationTimeline.prototype.getLastPlayedPoint = function (filter) {
                ...
                channels.forEach(function (c) {
                    var events = c.events.filter(function (e, ix, arr) {
                        return !!(e.relatedPoint && e.time <= curTime &&
            ...
            SonificationTimeline.prototype.cancel = function () {
                ...
                if (this.playingChannels && this.playingChannels !== this.channels) {
                    this.playingChannels.forEach(function (c) {
                        return c.cancel();
                    });
                }
                this.clearScheduledCallbacks();
            ...
            SonificationTimeline.prototype.setMasterVolume = function (vol) {
                this.channels.forEach(function (c) {
                    return c.engine.setMasterVolume(vol);
                });
            };
            SonificationTimeline.prototype.getMIDIData = function () {
                return toMIDI(this.channels.filter(function (c) {
                    return c.type === 'instrument';
                }));
            };
    ...
    _registerModule(_modules, 'Extensions/Sonification/TimelineFromChart.js', [_modules['Extensions/Sonification/SonificationTimeline.js'], _modules['Extensions/Sonification/SonificationInstrument.js'], _modules['Extensions/Sonification/SonificationSpeaker.js'], _modules['Core/Utilities.js'], _modules['Core/Templating.js']], function (SonificationTimeline, SonificationInstrument, SonificationSpeaker, U, T) {
        ...
        var clamp = U.clamp, defined = U.defined, extend = U.extend, getNestedProperty = U.getNestedProperty,
        ...
        function getChartExtremesForProps(chart, props, perSeriesProps) {
            var series = chart.series, numProps = props.length, numSeriesProps = perSeriesProps.length,
        ...
        function getPropMetrics(chart) {
            var globalOpts = chart.options.sonification ||
                ...
                addTimeProp = function (prop, seriesIx) {
                    if (seriesIx !== null) {
                    ...
                    var removeInvertedFlag = function (s) {
                ...
                }, addPropsFromContextTracks = function (tracks) {
        ...
        function getMappingParameterValue(context, propMetrics, useSeriesExtremes, defaultMapping, mappingOptions, contextValueProp) {
            ...
            var mapTo = mappingOptions, mapFunc = defaultMapping.mapFunction, min = defaultMapping.min,
            ...
            if (scale) {
                ...
                var scaleAxis = [], minOctave = Math.floor(min / 12), maxOctave = Math.ceil(max / 12) + 1,
                ...
                // Map to the scale
                var noteNum = mapToVirtualAxis(value, extremes, {
                    min: 0,
        ...
        function getPointTime(point, startTime, duration, timeMappingOptions, propMetrics, useSeriesExtremes) {
            var time = getParamValWithDefault({
                point: point,
                time: 0
        ...
        function getAvailableDurationForSeries(series, totalDuration, propMetrics, afterSeriesWait) {
            ...
            if (hasGlobalTimeProp) {
                ...
                var seriesExtremes = propMetrics
                    ...
                    totalTimeLen = propMetrics.seriesExtremes.reduce(function (sum, s) {
                        return (s[timeProp] ?
                ...
                var totalPoints = series.chart.series.reduce(function (sum, s) {
        ...
        function addMappedInstrumentEvent(context, channel, mappingOptions, propMetrics, roundToMusicalNotes, contextValueProp) {
            var getParam = function (param, fallback, defaults, parent) {
                return getParamValWithDefault(context, propMetrics, false, (parent || mappingOptions)[param], fallback, defaults, contextValueProp);
            };
            ...
            var gapBetweenNotes = getParam('gapBetweenNotes', 150, {min: 50, max: 1000}),
        ...
        function addMappedSpeechEvent(context, channel, mappingOptions, propMetrics, contextValueProp) {
            var getParam = function (param, fallback, defaults) {
                return getParamValWithDefault(context, propMetrics, false, mappingOptions[param], fallback, defaults, contextValueProp);
            };
            var playDelay = getParam('playDelay', 0, {max: 200}), pitch = getParam('pitch', 1, {min: 0.3, max: 2}),
        ...
        function getGroupedPoints(pointGroupOpts, points) {
            var alg = pointGroupOpts.algorithm || 'minmax', r = function (ix) {
                return (points[ix] ? [points[ix].point] : []);
            };
            if (alg === 'first') {
                return r(0);
            }
        ...
        function isActive(context, activeWhen, lastPropValue) {
            ...
            if (typeof activeWhen === 'object') {
                ...
                var crossingOk = true;
                var crossingUp = activeWhen.crossingUp, crossingDown = activeWhen.crossingDown,
        ...
        function timelineFromChart(audioContext, destinationNode, chart) {
            var options = chart.options.sonification ||
                ...
                defaultSpeechOpts = options.defaultSpeechOptions, defaultPointGroupOpts = merge({
                    enabled: true,
                    groupTimespan: 15,
                    algorithm: 'minmax',
                    prop: 'y'
                ...
                eventOptions = options.events || {}, propMetrics = getPropMetrics(chart),
            ...
            chart.series.forEach(function (series, seriesIx) {
                ...
                if (series.visible && sOptions.enabled !== false) {
                    var seriesDuration_1 = isSequential ? getAvailableDurationForSeries(series, totalDuration, propMetrics, afterSeriesWait) : totalDuration,
                        seriesDefaultInstrOpts_1 = merge(defaultInstrOpts, sOptions.defaultInstrumentOptions),
                        seriesDefaultSpeechOpts_1 = merge(defaultSpeechOpts, sOptions.defaultSpeechOptions),
                        seriesPointGroupOpts_1 = merge(defaultPointGroupOpts, sOptions.pointGrouping),
                    ...
                    mainTracks.forEach(function (trackOpts) {
                        var mergedOpts = merge({
                                ...
                                seriesDefaultSpeechOpts_1 : seriesDefaultInstrOpts_1, trackOpts),
                        ...
                        var channel = addTimelineChannelFromTrack(timeline, audioContext, destinationNode, mergedOpts),
                            add = function (c) {
                                return eventsAdded_1.push.apply(eventsAdded_1, addMappedEventForPoint(c, channel, mergedOpts, propMetrics));
                            };
                        ...
                        var addCurrentPointGroup = function (groupSpanTime) {
                            if (pointGroup.length === 1) {
                                ...
                                var points = getGroupedPoints(pointGroupOpts, pointGroup),
                        ...
                        (series.points || []).forEach(function (point, pointIx) {
                            ...
                            if (!pointGroupOpts.enabled) {
                                ...
                                var dT = time - pointGroupTime, groupSpan = pointGroupOpts.groupTimespan,
                    ...
                    var firstEvent = eventsAdded_1.reduce(function (first, e) {
                        return (e.time < first.time ? e : first);
                    }, {time: Infinity});
                    var lastEvent = eventsAdded_1.reduce(function (last, e) {
                        return (e.time > last.time ? e : last);
                    }, {time: -Infinity});
                    ...
                    contextTracks.forEach(function (trackOpts) {
                        ...
                        var timeInterval = mergedOpts.timeInterval, valueInterval = mergedOpts.valueInterval,
                            valueProp = mergedOpts.valueProp || 'x', activeWhen = mergedOpts.activeWhen,
                            contextExtremes = propMetrics
                                ...
                                if (mergedOpts.type === 'speech') {
                                    addMappedSpeechEvent({
                                        time: time,
                                        value: value
                                    }, contextChannel, mergedOpts.mapping, propMetrics, valueProp);
                                } else {
                        ...
                        if (valueInterval) {
                            ...
                            while (val <= contextExtremes.max) {
                                var time = mapToVirtualAxis(val, contextExtremes, {
                                    min: 0,
        ...
        var Sonification = /** @class */ (function () {
            ...
            Sonification.prototype.playAdjacentSeries = function (next, prop, onEnd) {
                ...
                if (lastPlayed) {
                    ...
                    this.playClosestToProp(prop, lastPlayed[prop], function (e) {
                        return !!e.relatedPoint &&
                            e.relatedPoint.series.index === targetSeriesIx_1;
                    }, onEnd);
            ...
            Sonification.prototype.sonifyPoint = function (point, onEnd) {
                ...
                if (this.timeline) {
                    this.timeline.reset();
                    this.beforePlay();
                    this.timeline.anchorPlayMoment(function (e) {
                        return e.relatedPoint === point;
                    }, onEnd);
                }
            };
