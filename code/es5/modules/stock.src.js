...
(function (factory) {
        ...
        (function (BrokenAxis) {
            ...
            var Additions = /** @class */ (function () {
                ...
                Additions.isInBreak = function (brk, val) {
                    var repeat = brk.repeat || Infinity, from = brk.from, length = brk.to - brk.from,
                        test = (val >= from ?
                            (val - from) % repeat :
    ...
    _registerModule(_modules, 'Extensions/DataGrouping/DataGroupingSeriesComposition.js', [_modules['Extensions/DataGrouping/ApproximationRegistry.js'], _modules['Extensions/DataGrouping/DataGroupingDefaults.js'], _modules['Core/Axis/DateTimeAxis.js'], _modules['Core/Defaults.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (ApproximationRegistry, DataGroupingDefaults, DateTimeAxis, D, SeriesRegistry, U) {
        ...
        var addEvent = U.addEvent, defined = U.defined, error = U.error, extend = U.extend, isNumber = U.isNumber,
        ...
        function groupData(xData, yData, groupPositions, approximation) {
            var series = this, data = series.data, dataOptions = series.options && series.options.data,
                groupedXData = [], groupedYData = [], groupMap = [], dataLength = xData.length,
    ...
    _registerModule(_modules, 'Extensions/DataGrouping/DataGrouping.js', [_modules['Extensions/DataGrouping/DataGroupingAxisComposition.js'], _modules['Extensions/DataGrouping/DataGroupingDefaults.js'], _modules['Extensions/DataGrouping/DataGroupingSeriesComposition.js'], _modules['Core/Templating.js'], _modules['Core/Utilities.js']], function (DataGroupingAxisComposition, DataGroupingDefaults, DataGroupingSeriesComposition, F, U) {
        ...
        function onTooltipHeaderFormatter(e) {
            var chart = this.chart, time = chart.time, labelConfig = e.labelConfig, series = labelConfig.series,
                options = series.options, tooltipOptions = series.tooltipOptions,
                dataGroupingOptions = options.dataGrouping, xAxis = series.xAxis;
            var xDateFormat = tooltipOptions.xDateFormat, xDateFormatEnd, currentDataGrouping, dateTimeLabelFormats,
    ...
    _registerModule(_modules, 'Extensions/MouseWheelZoom/MouseWheelZoom.js', [_modules['Core/Utilities.js']], function (U) {
        ...
        var wheelTimer, originalOptions;
        /**
         * @private
         */
        var zoomBy = function (chart, howMuch, centerXArg, centerYArg, mouseX, mouseY, options) {
            ...
            if (defined(xAxis.max) && defined(xAxis.min) &&
                ...
                if (zoomY) {
                    ...
                    var _a = yAxis.options, startOnTick = _a.startOnTick, endOnTick = _a.endOnTick;
                    if (!originalOptions) {
                ...
                var xRange = xAxis.max - xAxis.min, centerX = pick(centerXArg, xAxis.min + xRange / 2),
                    ...
                    outerWidth_1 = dataRangeX + dataRangeX * xAxis.options.minPadding +
                        dataRangeX * xAxis.options.maxPadding,
                    outerY = yAxis.dataMin - dataRangeY * yAxis.options.minPadding,
                    outerHeight_1 = dataRangeY + dataRangeY * yAxis.options.minPadding +
    ...
    _registerModule(_modules, 'Core/Axis/NavigatorAxisComposition.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (H, U) {
        ...
        var addEvent = U.addEvent, correctFloat = U.correctFloat, defined = U.defined, isNumber = U.isNumber,
            pick = U.pick;
        /* *
         *
         *  Constants
        ...
        function onAxisZoom(e) {
            var axis = this, chart = axis.chart, chartOptions = chart.options, navigator = chartOptions.navigator,
        ...
        var NavigatorAxisAdditions = /** @class */ (function () {
            ...
            NavigatorAxisAdditions.prototype.toFixedRange = function (pxMin, pxMax, fixedMin, fixedMax) {
                ...
                var newMin = pick(fixedMin, axis.translate(pxMin, true, !axis.horiz)),
        ...
        var ScrollbarAxis = /** @class */ (function () {
            ...
            ScrollbarAxis.compose = function (AxisClass, ScrollbarClass) {
                ...
                addEvent(AxisClass, 'afterInit', function () {
                    ...
                    if (axis.options &&
                        ...
                        addEvent(axis.scrollbar, 'changed', function (e) {
                            var _a = getExtremes(axis), axisMin = _a.axisMin, axisMax = _a.axisMax,
                                unitedMin = _a.scrollMin, unitedMax = _a.scrollMax, range = unitedMax - unitedMin, to,
                                from;
                ...
                addEvent(AxisClass, 'afterGetOffset', function () {
                    var axis = this, scrollbar = axis.scrollbar, opposite = scrollbar && !scrollbar.options.opposite,
    ...
    _registerModule(_modules, 'Stock/Scrollbar/Scrollbar.js', [_modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Core/Axis/ScrollbarAxis.js'], _modules['Stock/Scrollbar/ScrollbarDefaults.js'], _modules['Core/Utilities.js']], function (D, H, ScrollbarAxis, ScrollbarDefaults, U) {
        ...
        var Scrollbar = /** @class */ (function () {
            ...
            Scrollbar.prototype.position = function (x, y, width, height) {
                var scroller = this, options = scroller.options, buttonsEnabled = options.buttonsEnabled,
                    _a = options.margin, margin = _a === void 0 ? 0 : _a, vertical = options.vertical,
        ...
        var Navigator = /** @class */ (function () {
            ...
            Navigator.prototype.renderElements = function () {
                ...
                if (navigatorOptions.handles && navigatorOptions.handles.enabled) {
                    var handlesOptions_1 = navigatorOptions.handles, height_1 = handlesOptions_1.height,
            ...
            Navigator.prototype.render = function (min, max, pxMin, pxMax) {
                var navigator = this, chart = navigator.chart, xAxis = navigator.xAxis,
                ...
                var navigatorWidth, scrollbarLeft, scrollbarTop, scrollbarHeight = navigator.scrollbarHeight,
                    navigatorSize, verb;
                ...
                var newMin = xAxis.toValue(pxMin, true), newMax = xAxis.toValue(pxMax, true),
            ...
            Navigator.prototype.shadesMousedown = function (e, index) {
                ...
                var navigator = this, chart = navigator.chart, xAxis = navigator.xAxis, zoomedMin = navigator.zoomedMin,
                    navigatorSize = navigator.size, range = navigator.range;
            ...
            Navigator.prototype.onMouseMove = function (e) {
                var navigator = this, chart = navigator.chart, navigatorSize = navigator.navigatorSize,
            ...
            Navigator.prototype.updateNavigatorSeries = function (addEvents, redraw) {
                ...
                var baseOptions, mergedNavSeriesOptions,
            ...
            Navigator.prototype.shouldStickToMin = function (baseSeries, navigator) {
                var xDataMin = navigator.getBaseSeriesMin(baseSeries.xData[0]), xAxis = baseSeries.xAxis,
    ...
    _registerModule(_modules, 'Stock/RangeSelector/RangeSelectorComposition.js', [_modules['Core/Defaults.js'], _modules['Stock/RangeSelector/RangeSelectorDefaults.js'], _modules['Core/Utilities.js']], function (D, RangeSelectorDefaults, U) {
         ...
         * */
        var defaultOptions = D.defaultOptions, setOptions = D.setOptions;
        var addEvent = U.addEvent, defined = U.defined, extend = U.extend, find = U.find, isNumber = U.isNumber,
            merge = U.merge, pick = U.pick;
        /* *
         *
         *  Constants
        ...
        function onChartCallback(chart) {
            ...
            if (rangeSelector) {
                var events = find(chartDestroyEvents, function (e) {
                    return e[0] === chart;
                });
                if (!events) {
    ...
    _registerModule(_modules, 'Stock/RangeSelector/RangeSelector.js', [_modules['Core/Axis/Axis.js'], _modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Stock/RangeSelector/RangeSelectorComposition.js'], _modules['Core/Renderer/SVG/SVGElement.js'], _modules['Core/Utilities.js']], function (Axis, D, H, RangeSelectorComposition, SVGElement, U) {
        ...
        var addEvent = U.addEvent, createElement = U.createElement, css = U.css, defined = U.defined,
            ...
            fireEvent = U.fireEvent, isNumber = U.isNumber, merge = U.merge, objectEach = U.objectEach, pad = U.pad,
            pick = U.pick, pInt = U.pInt, splat = U.splat;
        ...
        var RangeSelector = /** @class */ (function () {
            ...
            RangeSelector.prototype.clickButton = function (i, redraw) {
                ...
                var dataMin = unionExtremes.dataMin, dataMax = unionExtremes.dataMax, newMin,
            ...
            RangeSelector.prototype.getYTDExtremes = function (dataMax, dataMin, useUTC) {
                var time = this.chart.time, now = new time.Date(dataMax), year = time.get('FullYear', now),
                    startOfYear = useUTC ?
            ...
            RangeSelector.prototype.render = function (min, max) {
                var chart = this.chart, renderer = chart.renderer, container = chart.container,
            ...
            RangeSelector.prototype.collapseButtons = function (xOffsetForExportButton) {
                var _a = this, buttons = _a.buttons, buttonOptions = _a.buttonOptions, chart = _a.chart,
                    dropdown = _a.dropdown, options = _a.options, zoomText = _a.zoomText;
            ...
            RangeSelector.prototype.showDropdown = function () {
                var _a = this, buttonGroup = _a.buttonGroup, buttons = _a.buttons, chart = _a.chart,
        ...
        (function (OrdinalAxis) {
            ...
            function lin2val(val) {
                ...
                if (positions && positions.length) {
                    ...
                    var index = indexOf !== -1 ? indexOf : correctFloat(ordinal.getIndexOfPoint(pixelVal, positions)),
            ...
            function onChartPan(e) {
                ...
                if (panning &&
                    ...
                    var trimmedRange = void 0, ordinalPositions = void 0, searchAxisLeft = void 0,
                ...
                * */
                ...
                Additions.prototype.beforeSetTickPositions = function () {
                    var axis = this.axis, ordinal = axis.ordinal, extremes = axis.getExtremes(), min = extremes.min,
                        max = extremes.max, hasBreaks = axis.isXAxis && !!axis.options.breaks,
                    ...
                    var len, uniqueOrdinalPositions, dist, minIndex, maxIndex, slope, i, ordinalPositions = [],
                        ...
                        adjustOrdinalExtremesPoints = false, isBoosted = false;
    ...
    _registerModule(_modules, 'Series/OHLC/OHLCSeries.js', [_modules['Series/OHLC/OHLCPoint.js'], _modules['Series/OHLC/OHLCSeriesDefaults.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (OHLCPoint, OHLCSeriesDefaults, SeriesRegistry, U) {
        ...
        var OHLCSeries = /** @class */ (function (_super) {
            ...
            OHLCSeries.prototype.getPointPath = function (point, graphic) {
                var path = _super.prototype.getPointPath.call(this, point, graphic),
                    strokeWidth = graphic.strokeWidth(), crispCorr = (strokeWidth % 2) / 2,
                    crispX = Math.round(point.plotX) - crispCorr, halfWidth = Math.round(point.shapeArgs.width / 2);
        ...
        var CandlestickSeries = /** @class */ (function (_super) {
            ...
            CandlestickSeries.prototype.drawPoints = function () {
                ...
                for (var _i = 0, points_1 = points; _i < points_1.length; _i++) {
                    ...
                    var graphic = point.graphic, plotOpen = void 0, plotClose = void 0, topBox = void 0,
                        bottomBox = void 0, hasTopWhisker = void 0, hasBottomWhisker = void 0, crispCorr = void 0,
                        crispX = void 0, path = void 0, halfWidth = void 0;
                    var isNew = !graphic;
                    if (typeof point.plotY !== 'undefined') {
                        if (!graphic) {
                            point.graphic = graphic = chart.renderer.path()
        ...
        (function (OnSeriesComposition) {
            ...
            function translate() {
                ...
                var series = this, options = series.options, chart = series.chart, points = series.points,
                    ...
                    yAxis = series.yAxis;
                var cursor = points.length - 1, point, lastPoint, onKey = options.onKey || 'y',
                    i = onData && onData.length, xOffset = 0, leftPoint, lastX, rightPoint, currentDataGrouping,
                    distanceRatio;
    ...
    _registerModule(_modules, 'Series/Flags/FlagsSeries.js', [_modules['Series/Flags/FlagsPoint.js'], _modules['Series/Flags/FlagsSeriesDefaults.js'], _modules['Series/Flags/FlagsSymbols.js'], _modules['Core/Globals.js'], _modules['Series/OnSeriesComposition.js'], _modules['Core/Renderer/RendererUtilities.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Renderer/SVG/SVGElement.js'], _modules['Core/Utilities.js']], function (FlagsPoint, FlagsSeriesDefaults, FlagsSymbols, H, OnSeriesComposition, R, SeriesRegistry, SVGElement, U) {
        ...
        var FlagsSeries = /** @class */ (function (_super) {
            ...
            FlagsSeries.prototype.drawPoints = function () {
                var series = this, points = series.points, chart = series.chart, renderer = chart.renderer,
            ...
            FlagsSeries.prototype.pointAttribs = function (point, state) {
                ...
                var lineColor = options.lineColor, lineWidth = (point && point.lineWidth),
    ...
    _registerModule(_modules, 'Core/Chart/StockChart.js', [_modules['Core/Axis/Axis.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Templating.js'], _modules['Core/Defaults.js'], _modules['Stock/Navigator/NavigatorDefaults.js'], _modules['Stock/RangeSelector/RangeSelectorDefaults.js'], _modules['Stock/Scrollbar/ScrollbarDefaults.js'], _modules['Core/Series/Series.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Axis, Chart, F, D, NavigatorDefaults, RangeSelectorDefaults, ScrollbarDefaults, Series, SVGRenderer, U) {
        ...
        addEvent(Axis, 'autoLabelAlign', function (e) {
            var _a = this, chart = _a.chart, options = _a.options, panes = chart._labelPanes = chart._labelPanes || {},
