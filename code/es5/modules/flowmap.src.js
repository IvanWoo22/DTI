...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/FlowMap/FlowMapSeries.js', [_modules['Series/FlowMap/FlowMapPoint.js'], _modules['Series/Map/MapSeries.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (FlowMapPoint, MapSeries, SeriesRegistry, U) {
        ...
        var Point = SeriesRegistry.series.prototype.pointClass, _a = SeriesRegistry.seriesTypes,
            ColumnSeries = _a.column, MapLineSeries = _a.mapline;
        var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, defined = U.defined, extend = U.extend,
            isArray = U.isArray, merge = U.merge, pick = U.pick, relativeLength = U.relativeLength;
        /**
        ...
        var FlowMapSeries = /** @class */ (function (_super) {
            ...
            FlowMapSeries.markerEndPath = function (lCorner, rCorner, topCorner, options) {
                ...
                var type = options.markerType || 'arrow',
                    _a = this.normalize(rCorner[0] - lCorner[0], rCorner[1] - lCorner[1]), edgeX = _a[0], edgeY = _a[1];
                var path = [];
                ...
                if (type === 'mushroom') {
                    ...
                    var xTop = topCorner[0], yTop = topCorner[1], xMid = (xRight - xLeft) / 2 + xLeft,
            ...
            FlowMapSeries.prototype.translate = function () {
                ...
                this.points.forEach(function (point) {
                    var chart = _this.chart, mapView = chart.mapView, options = point.options,
            ...
            FlowMapSeries.prototype.getPointShapeArgs = function (point) {
                ...
                var finalWidth = this.getLinkWidth(point) / 2, pointOptions = point.options,
                    ...
                    fromY = fromPos.y || 0;
                var toX = toPos.x || 0, toY = toPos.y || 0,
                ...
                if (offset) {
                    ...
                    var _b = FlowMapSeries.normalize(arcPointX_1 - toX, arcPointY_1 - toY), offsetX = _b[0],
                        offsetY = _b[1];
                    offsetX *= offset;
                    offsetY *= offset;
                    toX += offsetX;
                ...
                var _d = FlowMapSeries.normalize(arcPointX - fromX, arcPointY - fromY), fromXToArc = _d[0],
                    fromYToArc = _d[1];
                tmp = fromXToArc;
                ...
                var fromPoint = point.options.from, toPoint = point.options.to, fromLat = fromPoint.lat,
