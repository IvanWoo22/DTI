...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/PatternFill.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Defaults.js'], _modules['Core/Series/Point.js'], _modules['Core/Series/Series.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (A, Chart, H, D, Point, Series, SVGRenderer, U) {
        ...
        var addEvent = U.addEvent, defined = U.defined, erase = U.erase, merge = U.merge, pick = U.pick,
    ...
    _registerModule(_modules, 'Series/Pictorial/PictorialUtilities.js', [_modules['Core/Utilities.js']], function (U) {
        ...
        function rescalePatternFill(element, stackHeight, width, height, borderWidth) {
            ...
            if (match) {
                ...
                if (patternPath) {
                    ...
                    var scaleY = stackHeight / height / bBox.height, aspectRatio = bBox.width / bBox.height,
        ...
        return {
            rescalePatternFill: rescalePatternFill,
            invertShadowGroup: invertShadowGroup,
            getStackMetrics: getStackMetrics
        };
    });
    ...
    _registerModule(_modules, 'Series/Pictorial/PictorialSeries.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Chart/Chart.js'], _modules['Series/Pictorial/PictorialPoint.js'], _modules['Series/Pictorial/PictorialUtilities.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Axis/Stacking/StackItem.js'], _modules['Core/Utilities.js']], function (A, Chart, PictorialPoint, PictorialUtilities, SeriesRegistry, StackItem, U) {
        ...
        var PictorialSeries = /** @class */ (function (_super) {
            ...
            PictorialSeries.prototype.pointAttribs = function (point) {
                var pointAttribs = _super.prototype.pointAttribs.apply(this, arguments), seriesOptions = this.options,
                    series = this, paths = seriesOptions.paths;
                if (point && point.shapeArgs && paths) {
                    var shape = paths[point.index % paths.length], _a = getStackMetrics(series.yAxis, shape), y = _a.y,
                        height = _a.height, pathDef = shape.definition;
                    // New pattern, replace
            ...
            PictorialSeries.prototype.getExtremes = function () {
                var extremes = _super.prototype.getExtremes.apply(this, arguments), series = this,
        ...
        addEvent(PictorialSeries, 'afterRender', function () {
            ...
            series.points.forEach(function (point) {
                if (point.graphic && point.shapeArgs && paths) {
                    var shape = paths[point.index % paths.length], fill = point.graphic.attr('fill'),
                        match = fill && fill.match(fillUrlMatcher), _a = getStackMetrics(series.yAxis, shape), y = _a.y,
                        height = _a.height;
        ...
        function renderStackShadow(stack) {
            ...
            var stackKeys = Object
                ...
                }), allSeries = stack.axis.chart.series, seriesIndexes = stackKeys.map(function (key) {
            ...
            if (series &&
                ...
                var xAxis = series.xAxis, options = stack.axis.options, chart = stack.axis.chart,
                    stackShadow = stack.shadow, xCenter = xAxis.toPixels(stack.x, true),
                    x = chart.inverted ? xAxis.len - xCenter : xCenter, paths = series.options.paths || [],
                    index = stack.x % paths.length, shape = paths[index], width = series.getColumnMetrics &&
                        series.getColumnMetrics().width, _a = getStackMetrics(series.yAxis, shape), height = _a.height,
                    y = _a.y, shadowOptions = options.stackShadow,
                ...
                if (!stackShadow &&
                    ...
                    var fillUrlMatcher = /url\(([^)]+)\)/, fill = stackShadow.attr('fill'),
        ...
        addEvent(StackItem, 'afterSetOffset', function (e) {
            if (this.shadow) {
                var _a = this.axis, chart = _a.chart, len = _a.len, xOffset = e.xOffset, width = e.width,
