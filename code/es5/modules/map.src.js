...
(function (factory) {
    ...
    _registerModule(_modules, 'Core/Axis/Color/ColorAxis.js', [_modules['Core/Axis/Axis.js'], _modules['Core/Color/Color.js'], _modules['Core/Axis/Color/ColorAxisComposition.js'], _modules['Core/Axis/Color/ColorAxisDefaults.js'], _modules['Core/Legend/LegendSymbol.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (Axis, Color, ColorAxisComposition, ColorAxisDefaults, LegendSymbol, SeriesRegistry, U) {
        ...
        var ColorAxis = /** @class */ (function (_super) {
            ...
            ColorAxis.prototype.initDataClasses = function (userOptions) {
                var axis = this, chart = axis.chart, legendItem = axis.legendItem = axis.legendItem || {},
            ...
            ColorAxis.prototype.drawLegendSymbol = function (legend, item) {
                var _a;
                var axis = this, legendItem = item.legendItem || {}, padding = legend.padding,
                    legendOptions = legend.options, labelOptions = axis.options.labels,
                    itemDistance = pick(legendOptions.itemDistance, 10), horiz = axis.horiz,
                    width = pick(legendOptions.symbolWidth, horiz ? ColorAxis.defaultLegendLength : 12),
                    height = pick(legendOptions.symbolHeight, horiz ? 12 : ColorAxis.defaultLegendLength),
                    labelPadding = pick(
            ...
            ColorAxis.prototype.getSeriesExtremes = function () {
                ...
                var colorValArray, colorKey, colorValIndex, pointArrayMap, calculatedExtremes, cSeries,
            ...
            ColorAxis.prototype.drawCrosshair = function (e, point) {
                var axis = this, legendItem = axis.legendItem || {}, plotX = point && point.plotX,
    ...
    _registerModule(_modules, 'Maps/MapNavigation.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (Chart, H, U) {
         ...
         * */
        var doc = H.doc;
        var addEvent = U.addEvent, extend = U.extend, isNumber = U.isNumber, merge = U.merge, objectEach = U.objectEach,
            pick = U.pick;
        ...
        MapNavigation.prototype.update = function (options) {
            ...
            if (pick(o.enableButtons, o.enabled) && !chart.renderer.forExport) {
                ...
                objectEach(o.buttons, function (buttonOptions, n) {
                    ...
                    var text = buttonOptions.text, _b = buttonOptions.width, width = _b === void 0 ? 0 : _b,
                        _c = buttonOptions.height, height = _c === void 0 ? 0 : _c, _d = buttonOptions.padding,
                ...
                var isIntersectRect_1 = function (box1, box2) {
    ...
    _registerModule(_modules, 'Maps/MapUtilities.js', [], function () {
        ...
        var boundsFromPath = function (path) {
            var x2 = -Number.MAX_VALUE, x1 = Number.MAX_VALUE, y2 = -Number.MAX_VALUE, y1 = Number.MAX_VALUE,
                validBounds;
    ...
    _registerModule(_modules, 'Series/Map/MapPoint.js', [_modules['Series/ColorMapComposition.js'], _modules['Maps/MapUtilities.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (ColorMapComposition, MapUtilities, SeriesRegistry, U) {
        ...
        var MapPoint = /** @class */ (function (_super) {
            ...
            MapPoint.prototype.applyOptions = function (options, x) {
                var series = this.series, point = _super.prototype.applyOptions.call(this, options, x),
                    joinBy = series.joinBy;
                if (series.mapData && series.mapMap) {
                    var joinKey = joinBy[1], mapKey = _super.prototype.getNestedProperty.call(point, joinKey),
            ...
            MapPoint.prototype.getProjectedBounds = function (projection) {
                var path = MapPoint.getProjectedPath(this, projection), bounds = boundsFromPath(path),
                ...
                if (bounds) {
                    ...
                    // etc
                    var propMiddleLon = properties && properties['hc-middle-lon'],
    ...
    _registerModule(_modules, 'Extensions/GeoJSON.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Templating.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (Chart, F, H, U) {
        ...
        Chart.prototype.transformFromLatLon = function (latLon, transform) {
            ...
            var _a = transform.jsonmarginX, jsonmarginX = _a === void 0 ? 0 : _a, _b = transform.jsonmarginY,
                ...
                _d = transform.scale, scale = _d === void 0 ? 1 : _d, _e = transform.xoffset,
                xoffset = _e === void 0 ? 0 : _e, _f = transform.xpan, xpan = _f === void 0 ? 0 : _f,
                _g = transform.yoffset, yoffset = _g === void 0 ? 0 : _g, _h = transform.ypan,
                ypan = _h === void 0 ? 0 : _h;
        ...
        */
        ...
        function geojson(json, hType, series) {
            ...
            geojson.features.forEach(function (feature) {
                ...
                if (pointOptions) {
                    var name_1 = properties && (properties.name || properties.NAME), lon = properties && properties.lon,
    ...
    _registerModule(_modules, 'Core/Geometry/PolygonClip.js', [], function () {
        ...
        var intersection = function (clipEdge1, clipEdge2, prevPoint, currentPoint) {
            var dc = [
                ...
                n3 = 1 / (dc[0] * dp[1] - dc[1] * dp[0]), intersection = [
                    (n1 * dp[0] - n2 * dc[0]) * n3,
                    (n1 * dp[1] - n2 * dc[1]) * n3
                ];
        ...
        (function (PolygonClip) {
            ...
            PolygonClip.clipPolygon = function (subjectPolygon, boundsPolygon, closed) {
                ...
                var clipEdge1 = boundsPolygon[boundsPolygon.length - 1], clipEdge2, prevPoint, currentPoint,
    ...
    _registerModule(_modules, 'Maps/Projections/LambertConformalConic.js', [], function () {
        ...
        var sign = Math.sign ||
            ...
            }), scale = 63.78137, deg2rad = Math.PI / 180, halfPI = Math.PI / 2, eps10 = 1e-6, tany = function (y) {
        ...
        var LambertConformalConic = /** @class */ (function () {
            function LambertConformalConic(options) {
                ...
                var parallels = (options.parallels || [])
                        .map(function (n) {
                            return n * deg2rad;
                        }), lat1 = parallels[0] || 0, lat2 = (_a = parallels[1]) !== null && _a !== void 0 ? _a : lat1,
            ...
            LambertConformalConic.prototype.forward = function (lonLat) {
                ...
                var r = c / Math.pow(tany(lat), n), x = r * Math.sin(n * lon) * scale,
            ...
            LambertConformalConic.prototype.inverse = function (xy) {
                var x = xy[0] / scale, y = xy[1] / scale, _a = this, c = _a.c, n = _a.n, cy = c - y,
    ...
    _registerModule(_modules, 'Maps/Projections/EqualEarth.js', [], function () {
        ...
        var EqualEarth = /** @class */ (function () {
            ...
            EqualEarth.prototype.forward = function (lonLat) {
                var d = Math.PI / 180, paramLat = Math.asin(M * Math.sin(lonLat[1] * d)),
                    paramLatSq = paramLat * paramLat, paramLatPow6 = paramLatSq * paramLatSq * paramLatSq;
    ...
    _registerModule(_modules, 'Maps/Projections/Orthographic.js', [], function () {
        ...
        var Orthographic = /** @class */ (function () {
            ...
            Orthographic.prototype.inverse = function (xy) {
                var x = xy[0] / scale, y = xy[1] / scale, z = Math.sqrt(x * x + y * y), c = Math.asin(z),
                    cSin = Math.sin(c), cCos = Math.cos(c);
                return [
    ...
    _registerModule(_modules, 'Maps/Projection.js', [_modules['Core/Geometry/PolygonClip.js'], _modules['Maps/Projections/ProjectionRegistry.js'], _modules['Core/Utilities.js']], function (PC, registry, U) {
        ...
        var Projection = /** @class */ (function () {
            ...
            Projection.prototype.getRotator = function (rotation) {
                ...
                var cosDeltaPhi = Math.cos(deltaPhi), sinDeltaPhi = Math.sin(deltaPhi),
                    cosDeltaGamma = Math.cos(deltaGamma), sinDeltaGamma = Math.sin(deltaGamma);
                ...
                return {
                    forward: function (lonLat) {
                        ...
                        var lat = lonLat[1] * deg2rad, cosLat = Math.cos(lat), x = Math.cos(lon) * cosLat,
                            y = Math.sin(lon) * cosLat, sinLat = Math.sin(lat),
                    ...
                    if (isPolygon) {
                        ...
                        if (polarIntersection) {
                            for (var i_1 = 0; i_1 < polygons.length; i_1++) {
                                var direction = polarIntersection.direction, lat = polarIntersection.lat,
                                    poly_1 = polygons[i_1], indexOf = poly_1.indexOf(polarIntersection.lonLat);
                                if (indexOf > -1) {
    ...
    _registerModule(_modules, 'Maps/MapView.js', [_modules['Maps/MapViewOptionsDefault.js'], _modules['Maps/MapViewInsetsOptionsDefault.js'], _modules['Extensions/GeoJSON.js'], _modules['Core/Chart/MapChart.js'], _modules['Maps/MapUtilities.js'], _modules['Maps/Projection.js'], _modules['Core/Utilities.js']], function (defaultOptions, defaultInsetsOptions, GeoJSONModule, MapChart, MU, Projection, U) {
        ...
        var addEvent = U.addEvent, clamp = U.clamp, fireEvent = U.fireEvent, isArray = U.isArray, isNumber = U.isNumber,
            isObject = U.isObject, isString = U.isString, merge = U.merge, pick = U.pick,
        ...
        var zoomFromBounds = function (b, playingField) {
            var width = playingField.width, height = playingField.height,
        ...
        var MapView = /** @class */ (function () {
            function MapView(chart, options) {
                ...
                if (!(this instanceof MapViewInset)) {
                    ...
                    ], (chart.options.series || []).map(function (s) {
                        return s.mapData;
                    }), true).map(function (mapData) {
            ...
            MapView.prototype.fitToBounds = function (bounds, padding, redraw, animation) {
                ...
                if (b) {
                    var pad = pick(padding, bounds ? 0 : this.options.padding), fullField = this.getField(false),
                    ...
                    if (!this.fitToGeometryCache) {
                        if (fitToGeometry.type === 'MultiPoint') {
                            var positions = fitToGeometry.coordinates
                                ...
                                }), xs = positions.map(function (pos) {
                                return pos[0];
                            }), ys = positions.map(function (pos) {
                                return pos[1];
                            });
            ...
            MapView.prototype.getSVGTransform = function () {
                var _a = this.playingField, x = _a.x, y = _a.y, width = _a.width, height = _a.height,
                    projectedCenter = this.projection.forward(this.center),
                    flipFactor = this.projection.hasCoordinates ? -1 : 1, scaleX = this.getScale(),
                    scaleY = scaleX * flipFactor, translateX = x + width / 2 - projectedCenter[0] * scaleX,
            ...
            MapView.prototype.lonLatToProjectedUnits = function (lonLat) {
                ...
                for (var _i = 0, _a = this.insets; _i < _a.length; _i++) {
                    ...
                    if (inset.options.geoBounds &&
                        ...
                        var insetProjectedPoint = inset.projection.forward([lonLat.lon, lonLat.lat]),
                ...
                for (var _i = 0, _a = this.insets; _i < _a.length; _i++) {
                    ...
                    if (inset.hitZone &&
                        ...
                        var insetProjectedPoint = inset
                            ...
                            coordinates_1 = inset.projection.inverse([insetProjectedPoint.x, insetProjectedPoint.y]);
            ...
            MapView.prototype.setView = function (center, zoom, redraw, animation) {
                ...
                if (bounds) {
                    var projectedCenter = this.projection.forward(this.center), _a = this.playingField, x = _a.x,
                        y = _a.y, width = _a.width, height = _a.height, scale = this.getScale(),
            ...
            MapView.prototype.projectedUnitsToPixels = function (pos) {
                var scale = this.getScale(), projectedCenter = this.projection.forward(this.center),
                    field = this.playingField, centerPxX = field.x + field.width / 2,
            ...
            MapView.prototype.pixelsToProjectedUnits = function (pos) {
                var x = pos.x, y = pos.y, scale = this.getScale(),
                    projectedCenter = this.projection.forward(this.center), field = this.playingField,
                    centerPxX = field.x + field.width / 2, centerPxY = field.y + field.height / 2;
            ...
            MapView.prototype.setUpEvents = function () {
                ...
                var onPan = function (e) {
                    ...
                    if (typeof mouseDownX === 'number' &&
                        ...
                        var key = "".concat(mouseDownX, ",").concat(mouseDownY), _a = e.originalEvent,
                            chartX = _a.chartX, chartY = _a.chartY;
                ...
                addEvent(chart, 'selection', function (evt) {
                    ...
                    if (!evt.resetSelection) {
                        ...
                        var _b = _this.pixelsToProjectedUnits({x: x + evt.width, y: y + evt.height}), y2 = _b.y,
                            x2 = _b.x;
        ...
        var MapViewInset = /** @class */ (function (_super) {
            ...
            function MapViewInset(mapView, options) {
                ...
                if (_this.options.geoBounds) {
                    ...
                    _this.geoBoundsProjectedPolygon = path.map(function (segment) {
                        return [
                            segment[1] || 0,
                            segment[2] || 0
                        ];
            ...
            MapViewInset.prototype.getField = function (padded) {
                ...
                if (hitZone) {
                    var padding = padded ? this.padding : [0, 0, 0, 0], polygon = hitZone.coordinates[0],
                        xs = polygon.map(function (xy) {
                            return xy[0];
                        }), ys = polygon.map(function (xy) {
                            return xy[1];
                        }), x = Math.min.apply(0, xs) + padding[3], x2 = Math.max.apply(0, xs) - padding[1],
                        y = Math.min.apply(0, ys) + padding[0], y2 = Math.max.apply(0, ys) - padding[2];
            ...
            MapViewInset.prototype.getHitZone = function () {
                var _a = this, chart = _a.chart, mapView = _a.mapView, options = _a.options,
                ...
                if (coordinates) {
                    ...
                    if (options.units === 'percent') {
                        ...
                        polygon = polygon.map(function (xy) {
                            return [
            ...
            MapViewInset.prototype.isInside = function (point) {
                var _a = this, geoBoundsProjectedBox = _a.geoBoundsProjectedBox,
    ...
    _registerModule(_modules, 'Series/Map/MapSeries.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Series/ColorMapComposition.js'], _modules['Series/CenteredUtilities.js'], _modules['Core/Globals.js'], _modules['Core/Chart/MapChart.js'], _modules['Series/Map/MapPoint.js'], _modules['Maps/MapView.js'], _modules['Core/Series/Series.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (A, ColorMapComposition, CU, H, MapChart, MapPoint, MapView, Series, SeriesRegistry, SVGRenderer, U) {
        ...
        var extend = U.extend, find = U.find, fireEvent = U.fireEvent, getNestedProperty = U.getNestedProperty,
            isArray = U.isArray, defined = U.defined, isNumber = U.isNumber, isObject = U.isObject, merge = U.merge,
        ...
        var MapSeries = /** @class */ (function (_super) {
            ...
            MapSeries.prototype.drawPoints = function () {
                var _this = this;
                var series = this, _a = this, chart = _a.chart, group = _a.group, _b = _a.transformGroups,
                    transformGroups = _b === void 0 ? [] : _b, mapView = chart.mapView, renderer = chart.renderer;
                if (!mapView) {
                    return;
                }
                        ...
                        if (graphic) {
                            ...
                            graphic.animate = function (params, options, complete) {
                                var animateIn = (isNumber(params['stroke-width']) &&
                                    ...
                                    animateOut = (isNumber(graphic['stroke-width']) &&
                ...
                transformGroups.forEach(function (transformGroup, i) {
                    var view = i === 0 ? mapView : mapView.insets[i - 1], svgTransform = view.getSVGTransform(),
                            ...
                            if (!point.bounds) {
                                ...
                                if (bounds) {
                                    ...
                                    if (insets_1 && isNumber(midX_1) && isNumber(midY_1)) {
                                        var inset = find(insets_1, function (inset) {
                                            return inset.isInside({
                                                x: midX_1, y: midY_1
                                            });
                                        });
                                        if (inset) {
            ...
            MapSeries.prototype.processData = function () {
                var options = this.options, data = options.data, chartOptions = this.chart.options.chart,
                    joinBy = this.joinBy, pointArrayMap = options.keys || this.pointArrayMap, dataUsed = [],
                    mapMap = {};
    ...
    _registerModule(_modules, 'Series/Bubble/BubbleLegendItem.js', [_modules['Core/Color/Color.js'], _modules['Core/Templating.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (Color, F, H, U) {
        ...
        var BubbleLegendItem = /** @class */ (function () {
            ...
            BubbleLegendItem.prototype.drawLegendSymbol = function (legend) {
                var chart = this.chart, itemDistance = pick(legend.options.itemDistance, 20),
            ...
            BubbleLegendItem.prototype.render = function () {
                var legendItem = this.legendItem || {}, renderer = this.chart.renderer,
            ...
            BubbleLegendItem.prototype.renderRange = function (range) {
                var mainRange = this.ranges[0], legend = this.legend, options = this.options,
                    labelsOptions = options.labels, chart = this.chart,
                    bubbleSeries = chart.series[options.seriesIndex], renderer = chart.renderer, symbols = this.symbols,
                    labels = symbols.labels, elementCenter = range.center, absoluteRadius = Math.abs(range.radius),
                    connectorDistance = options.connectorDistance || 0, labelsAlign = labelsOptions.align,
                    rtl = legend.options.rtl, borderWidth = options.borderWidth,
            ...
            BubbleLegendItem.prototype.predictBubbleSizes = function () {
                var chart = this.chart, legendOptions = chart.legend.options, floating = legendOptions.floating,
    ...
    _registerModule(_modules, 'Series/Bubble/BubbleSeries.js', [_modules['Series/Bubble/BubbleLegendComposition.js'], _modules['Series/Bubble/BubblePoint.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (BubbleLegendComposition, BubblePoint, Color, H, SeriesRegistry, U) {
        ...
        var color = Color.parse;
        var noop = H.noop;
        var Series = SeriesRegistry.series, _a = SeriesRegistry.seriesTypes, columnProto = _a.column.prototype,
        ...
        function axisBeforePadding() {
            var _this = this;
            var axisLength = this.len, chart = this.chart, isXAxis = this.isXAxis,
                dataKey = isXAxis ? 'xData' : 'yData', min = this.min, range = this.max - min;
        ...
        var BubbleSeries = /** @class */ (function (_super) {
            ...
            BubbleSeries.prototype.translateBubble = function () {
                var _a = this, data = _a.data, options = _a.options, radii = _a.radii,
        ...
        var HeatmapPoint = /** @class */ (function (_super) {
            ...
            HeatmapPoint.prototype.getCellAttributes = function () {
                var point = this, series = point.series, seriesOptions = series.options,
                    xPad = (seriesOptions.colsize || 1) / 2, yPad = (seriesOptions.rowsize || 1) / 2,
            ...
            HeatmapPoint.prototype.haloPath = function (size) {
                ...
                var _a = this.shapeArgs || {}, _b = _a.x, x = _b === void 0 ? 0 : _b, _c = _a.y,
    ...
    _registerModule(_modules, 'Series/Heatmap/HeatmapSeries.js', [_modules['Core/Color/Color.js'], _modules['Series/ColorMapComposition.js'], _modules['Core/Globals.js'], _modules['Series/Heatmap/HeatmapPoint.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Color, ColorMapComposition, H, HeatmapPoint, SeriesRegistry, SVGRenderer, U) {
        ...
        var Series = SeriesRegistry.series, _a = SeriesRegistry.seriesTypes, ColumnSeries = _a.column,
            ScatterSeries = _a.scatter;
        var symbols = SVGRenderer.prototype.symbols;
        var clamp = U.clamp, extend = U.extend, fireEvent = U.fireEvent, isNumber = U.isNumber, merge = U.merge,
            pick = U.pick, defined = U.defined;
        /* *
         *
         *  Class
         *
        ...
        var HeatmapSeries = /** @class */ (function (_super) {
            ...
            HeatmapSeries.prototype.drawPoints = function () {
                var series = this, seriesOptions = series.options, interpolation = seriesOptions.interpolation,
                    seriesMarkerOptions = seriesOptions.marker || {};
                if (interpolation) {
                    var image = series.image, chart = series.chart, xAxis_1 = series.xAxis, yAxis = series.yAxis,
                        points = series.points, lastPointIndex = points.length - 1, xAxisLen = xAxis_1.len,
                        xRev = xAxis_1.reversed, yAxisLen = yAxis.len, yRev = yAxis.reversed,
                        _a = xAxis_1.getExtremes(), xMin_1 = _a.min, xMax_1 = _a.max, _b = yAxis.getExtremes(),
                        yMin_1 = _b.min, yMax_1 = _b.max, _c = [
                            pick(seriesOptions.colsize, 1),
                            pick(seriesOptions.rowsize, 1)
                        ], colsize = _c[0], rowsize = _c[1], inverted = chart.inverted, xTranslationPad = colsize / 2,
                        userMinPadding = xAxis_1.userOptions.minPadding, isUserMinPadZero = (defined(userMinPadding) &&
                            !(userMinPadding > 0)), noOffset = (inverted || isUserMinPadZero),
                        padIfMinSet = (isUserMinPadZero && xTranslationPad || 0), _d = [
                            xMin_1 - padIfMinSet,
                            xMax_1 + (padIfMinSet * 2),
                            isUserMinPadZero && 0 || (xMin_1 + colsize)
                        ].map(function (side) {
                            return (clamp(Math.round(xAxis_1.len -
                                xAxis_1.translate(side, false, true, false, true, -series.pointPlacementToXValue())), -xAxis_1.len, 2 * xAxis_1.len));
                        }), x1 = _d[0], x2 = _d[1], postTranslationOffset = _d[2], _e = xRev ? [x2, x1] : [x1, x2],
                        xStart = _e[0], xEnd = _e[1], xOffset = (noOffset && 0 ||
                    ...
                    if (!image || series.isDirtyData) {
                        ...
                        if (canvas && ctx && colorAxis_1) {
                            var canvasWidth_1 = canvas.width = ~~((xMax_1 - xMin_1) / colsize) + 1,
                                canvasHeight = canvas.height = ~~((yMax_1 - yMin_1) / rowsize) + 1,
                                canvasArea = canvasWidth_1 * canvasHeight,
                                pixelData = new Uint8ClampedArray(canvasArea * 4),
                                widthLastIndex_1 = (canvasWidth_1 - (noOffset && 1 || 0)),
                                heightLastIndex_1 = canvasHeight - 1, colorFromPoint = function (p) {
                                    var rgba = (colorAxis_1.toColor(p.value ||
                                        ...
                                        .split(',')
                                        .map(function (s) {
                                            return pick(parseFloat(s), parseInt(s, 10));
                                        }));
                                    rgba[3] = pick(rgba[3], 1.0) * 255;
                                    return rgba;
                                }, scaleToImg_1 = function (val, fromMin, fromMax, toMin, toMax) {
                                    return ~~((val - fromMin) * ((toMax - toMin) /
                                        (fromMax - fromMin)));
                                }, xPlacement_1 = (xRev ?
                                    function (xToImg) {
                                        return (widthLastIndex_1 - xToImg);
                                    } :
                                    function (xToImg) {
                                        return xToImg;
                                    }), yPlacement_1 = (yRev ?
                                    function (yToImg) {
                                        return (heightLastIndex_1 - yToImg);
                                    } :
                                    function (yToImg) {
                                        return yToImg;
                                    }), scaledPointPos = function (x, y) {
                                    return (Math.ceil(canvasWidth_1 *
                            ...
                            for (var i = 0; i < canvasArea; i++) {
                                var toPointScale = scaleToImg_1(i * 4, 0, pixelData.length - 4, 0, lastPointIndex),
            ...
            HeatmapSeries.prototype.translate = function () {
                var series = this, options = series.options, borderRadius = options.borderRadius,
                    marker = options.marker, symbol = marker && marker.symbol || 'rect',
                    shape = symbols[symbol] ? symbol : 'rect',
                    hasRegularShape = ['circle', 'square'].indexOf(shape) !== -1;
                series.generatePoints();
                series.points.forEach(function (point) {
                    var cellAttr = point.getCellAttributes();
                    var x = Math.min(cellAttr.x1, cellAttr.x2), y = Math.min(cellAttr.y1, cellAttr.y2),
