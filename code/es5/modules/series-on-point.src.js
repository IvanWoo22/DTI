    ...
    _registerModule(_modules, 'Series/SeriesOnPointComposition.js', [_modules['Core/Series/Point.js'], _modules['Core/Series/Series.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Point, Series, SeriesRegistry, SVGRenderer, U) {
        ...
        (function (SeriesOnPointComposition) {
            ...
            function compose(SeriesClass, ChartClass) {
                var _a = Additions.prototype, chartGetZData = _a.chartGetZData, seriesAfterInit = _a.seriesAfterInit,
                    seriesAfterRender = _a.seriesAfterRender, seriesGetCenter = _a.seriesGetCenter,
                    seriesShowOrHide = _a.seriesShowOrHide, seriesTranslate = _a.seriesTranslate;
            ...
            var Additions = /** @class */ (function () {
                ...
                Additions.prototype.getConnectorAttributes = function () {
                    ...
                    var connectorOpts = onPointOptions.connectorOptions || {}, position = onPointOptions.position,
                    ...
                    var xFrom = defined(position.x) ?
                            ...
                            position.y :
                            connectedPoint.plotY, xTo = xFrom + (position.offsetX || 0),
                        yTo = yFrom + (position.offsetY || 0), width = connectorOpts.width || 1,
                        color = connectorOpts.stroke || this.series.color, dashStyle = connectorOpts.dashstyle,
                        attribs = {
