...
(function (factory) {
    ...
    _registerModule(_modules, 'Core/HttpUtilities.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (G, U) {
         ...
         * */
        var doc = G.doc;
        var createElement = U.createElement, discardElement = U.discardElement, merge = U.merge,
    ...
    _registerModule(_modules, 'Extensions/Data.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Core/HttpUtilities.js'], _modules['Core/Series/Point.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (Chart, D, G, HU, Point, SeriesRegistry, U) {
        ...
        var Data = /** @class */ (function () {
            ...
            Data.prototype.parseCSV = function (inOptions) {
                var self = this, columns = this.columns = [], options = inOptions || this.options,
                    startColumn = (typeof options.startColumn !== 'undefined' &&
                        options.startColumn) ? options.startColumn : 0,
                    endColumn = options.endColumn || Number.MAX_VALUE, dataTypes = [],
            ...
            Data.prototype.parseTable = function () {
                var options = this.options, columns = this.columns || [], startRow = options.startRow || 0,
            ...
            Data.prototype.fetchLiveData = function () {
                var data = this, chart = this.chart, options = this.options, maxRetries = 3,
            ...
            Data.prototype.parseColumn = function (column, col) {
                var rawColumns = this.rawColumns, columns = this.columns, firstRowAsNames = this.firstRowAsNames,
                    isXColumn = this.valueCount.xColumns.indexOf(col) !== -1, backup = [],
                    chartOptions = this.chartOptions, columnTypes = this.options.columnTypes || [],
